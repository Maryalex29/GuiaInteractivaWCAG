var typesite="classique";var mobiSite=false;var oldMobiSite=-1;var sizesite=400;var titlePage=new Array();var oriTypeSite="classique";var xcoord=0;var ycoord=0;var domainesN_T;var domainesN_F;var domainesPour;var domainesRemarques;var learnerName="";var Variable1="";var Variable2="";var Variable3="";var Variable4="";var Variable5="";var Variable6="";var Variable7="";var Variable8="";var Variable9="";var Variable10="";var langue='fr';var zoom=1;var IE8=0; var IE9=0; var IOS=0;var langueextend='';var haveNoSyntaxInScreen=true;var oldnav=false;var largEcranWidth=960; var largEcranHeight=720;var externdata=''; var externdatafilterpage=0;var fullscreen=false; var forceScreen=false;var screen90=false; var easyLoading=true;var CanalTempo=1;var forkDragDrop=0;var screenTime=0;function initializeLang(){
var baseLang='en';try{if(navigator.userLanguage){
...
var rax=960;var ray=720;if(mobiSite){
rax=480;
ray=780;
}
}
largEcranWidth=rax;
largEcranHeight=ray;
var largx=0;var largy=0;largx=rax * zoom;
largy=ray * zoom;
$('.unselectable').css({transition : 'all 0.5s ease'});
var mainObjet=$("#main");var nh=parseInt(getWindowHeight()) ;var nw= parseInt(getWindowWidth());var ratio=rax/ray;var ecart=50;largx=nw - ecart;
largy=nh - ecart;
if(largx>largy){
...
function resizeApp(){
var nh=parseInt(getWindowHeight());var nw=parseInt(getWindowWidth());if(istablet()){
var nheight=nh + 'px';
...
var largx=0;var largy=0;var rax=960;var ray=720;if(typesite=="mobile"){
rax=480;
ray=780;
largEcranWidth=rax;
largEcranHeight=ray;
...
if(typesite=="fixe"){
var Gratio=720/960;rax=sizesite;
...
var ratio=rax/ray;var ecart=50;var topScreen=false;if(typesite=="mobile"){ecart=1;}
if(typesite!="fixe"){
largx=nw - ecart;
largy=nh - ecart;
if(largx>largy){
...
var ctrRatio=rax/ray;var ctrRatioA=nw/nh;if(ctrRatioA>ctrRatio){
largy=nh - 32;
largx=parseInt(largy * ratio);
topScreen=true;
...
largx=nw - 4;
largy=parseInt(largx / ratio);
var ratioCal=nw/nh;if(ratioCal>0.62){
largy=nh-20;
largx=parseInt(largy * ratio);
}
}
...
var ctrratioscreen=nw / nh;if(ctrratioscreen>1.36){
...
var ctrratioscreen=nw / nh;if(ctrratioscreen>1.5){
...
var collObjets=$("#main,#loaddiv,#loaddivbarre,#lightbox,#globaltransition,#globalcurtain,#game");collObjets.css("position","absolute");
...
if(typesite=="mobile"){
if(navigator.userAgent.toUpperCase().indexOf("ANDROID") != -1){
var screenh=parseInt(getWindowHeight()) ;var screenw= parseInt(getWindowWidth());if(screenw>screenh){
zoom=(screenh-15) / rax;
largx=rax * zoom;
largy=ray * zoom;;
collObjets.css("width" ,largx + "px");
...
var cadreDecY=10;var headerHeight=45;var bodyHeight=parseInt($("#main").width() - parseInt(24 * zoom));var bodyY =parseInt(12 * zoom) - 2;if(headerfond=='1'||headerfond==1){
...
if(headerfond=='1'||headerfond==1){
var fdheader=$("#cadreheader");fdheader.css("left",'-1px');
...
if(footerfond=='1'||footerfond==1){
var fdfooter=$("#cadrefooter");fdfooter.css("left",'-1px');
...
var fdcadre=$("#cadrefond");fdcadre.css("left", parseInt(12 * zoom) + 'px');
...
$(function(){
resizeApp();
var useragt=navigator.userAgent.toUpperCase();if(useragt.indexOf("MSIE 8") != -1||useragt.indexOf("MSIE 7") != -1){
IE8=1;
}
...
resizeApp();
var t=setTimeout("resizeApp()",1000);$(".preloadclock").css("top","-100px");
initializeDomaines();
if(gebi("main")){
if(noDragDrop()){
forkDragDrop=1;
...
var pagenum=getParamValue("ps");if(pagenum!=""){
if(pagenum.length>6){
...
var UrlInteractions=getParamValue("resume");if(UrlInteractions!=""){
openUrlInteractions(UrlInteractions);
}
var UrlSave=getParamValue("save");if(UrlSave!=""){
openUrlSave(UrlSave);
}
unselect();
...
if(!noDragDrop()){
var main_map=document.getElementById("main");main_map.onmousemove=function(e){
calculCoord(e);
moveDrag();
movePhysics();
};
...
var evolinit=1;function allaysOnTop(){
if(istablet()){
...
if(haveLocalFileUrl()){
evolinit=evolinit + 25;
var wbh=getParamValue("wb");if(wbh==1){
...
var ur=window.location.href;if(ur.indexOf("BatisseursNumeriques")!=-1){
...
var uagent=navigator.userAgent.toUpperCase();if(uagent.indexOf("OPERA") != -1){
return true;
}
...
var ur=window.location.href;if(ur.indexOf("file://")!=-1){
return true;
}
return false;
}
function istablet(){
var tablet=false;if(navigator.userAgent.toUpperCase().indexOf("IPAD") != -1){
tablet=true;
}
if(navigator.userAgent.toUpperCase().indexOf("ANDROID") != -1){
tablet=true;
...
var fulls=false;var uagent=navigator.userAgent.toUpperCase();if(uagent.indexOf("IPAD") != -1){
fulls=true;
}
if(uagent.indexOf("ANDROID") != -1){
fulls=true;
...
var fulls=false;var uagent=navigator.userAgent.toUpperCase();if(uagent.indexOf("ANDROID") != -1){
fulls=true;
}
if(uagent.indexOf("CHROME") != -1){
fulls=true;
...
function isMsie(){
var Msie=false;if(navigator.userAgent.toUpperCase().indexOf("MSIE") != -1){
Msie=true;
}
if(isWindows()){
Msie=true;
...
function isMozilla(){
var Moz=false;if(navigator.userAgent.toUpperCase().indexOf("FIREFOX") != -1){
Moz=true;
}
return Moz;
}
function isSafari(){
var Saf=false;if(navigator.userAgent.toUpperCase().indexOf("SAFARI") != -1){
Saf=true;
}
return Saf;
}
function isIOS(){
var Saf=false;if(navigator.userAgent.toUpperCase().indexOf("IPOD") != -1){
Saf=true;
}
...
function isSurface(){
var surf=false;if(navigator.userAgent.toUpperCase().indexOf("ARM") != -1){
...
function isWindows(){
var wind=false;if(navigator.userAgent.toUpperCase().indexOf("ARM") == -1){
...
function noDragDrop(){
var nodd=false;if('ontouchstart' in document.documentElement){
return false;
}
if(navigator.userAgent.toUpperCase().indexOf("WINDOWS PHONE") != -1){
nodd=true;
...
var isSVGcomp=false;var nav=navigator.userAgent.toUpperCase();if(nav.indexOf("CHROME") != -1){
isSVGcomp=true;
}
...
function recupCss3(){
var Css3=false;if(navigator.userAgent.toUpperCase().indexOf("WINDOWS PHONE") != -1){
Css3=true;
}
if(navigator.userAgent.toUpperCase().indexOf("ANDROID") != -1){
Css3=true;
...
function haveCss3D(){
var Css3=true;if(navigator.userAgent.toUpperCase().indexOf("MSIE 9.0") != -1){
Css3=false;
}
...
var uagent=navigator.userAgent.toLowerCase();if(uagent.search(name) > -1){
return true;
}else{
return false;
}
...
try{if(!window.localStorage.getItem(name)){
...
if(f!=''){
try{if(!document.getElementById("noCacheManifest")){
if(localStorage){
$.ajax({
type: "GET",
url: f,
...
var nind=parseInt(obj.ind);if(nind>1){
nind=nind -1 ;
}
var bullecss="bullewhite";if(obj.boite=="bbullewhite"||obj.boite=="bcbullewhite"||obj.boite=="bdbullewhite"){
var cssPlus="";if(obj.css){
cssPlus=obj.css;
}
...
var eachElem=obj.contentpath.split(';');if(mobiSite){
...
var exb=parseInt(parseInt(obj.getX() - 15) );var eyb=parseInt(parseInt(obj.getY() - 15));var wbb=parseInt(parseInt(obj.getW() + 30));
...
var eachBulles=obj.contentpath.split(';');if(mobiSite){
eachBulles=obj.contentpathsecond.split(';');
}
var BigImage=eachBulles[0];var h='<img style="position:absolute;z-index:' + nind + ';" ';
h += ' src="images/' + BigImage + '" ';
h += ' id="clouding' + obj.id + '" unselectable="on" ' ;
h += ' class="clouding' + obj.id + ' alterbloc' + obj.id + ' unselectable" />';
var BackColor=eachBulles[1];var PenColor=eachBulles[2];var PenSize=eachBulles[3];if(PenSize>2){
PenSize=2;
}
var P1x=eachBulles[4];var P1y=eachBulles[5];var P1w=eachBulles[6];var P1h=eachBulles[7];h += '<div class="cloudAbull' + obj.id + ' alterbloc' + obj.id + ' unselectable" style="position:absolute;z-index:' + nind + ';';
...
h += '" ></div>';
var P2x=eachBulles[8];var P2y=eachBulles[9];var P2w=eachBulles[10];var P2h=eachBulles[11];h += '<div class="cloudBbull' + obj.id + ' alterbloc' + obj.id + ' unselectable" style="position:absolute;z-index:' + nind + ';';
h += 'background-color:' + BackColor + ';';
h += 'border: solid ' + PenSize + 'px ' + PenColor + ';';
h += 'border-radius: 50%;';
...
h += '" ></div>';
var P3x=eachBulles[12];var P3y=eachBulles[13];var P3w=eachBulles[14];var P3h=eachBulles[15];h += '<div class="cloudCbull' + obj.id + ' alterbloc' + obj.id + ' unselectable" style="position:absolute;z-index:' + nind + ';';
h += 'background-color:' + BackColor + ';';
h += 'border: solid ' + PenSize + 'px ' + PenColor + ';';
h += 'border-radius: 50%;';
...
h += '" ></div>';
var P4x=eachBulles[16];var P4y=eachBulles[17];var P4w=eachBulles[18];var P4h=eachBulles[19];h += '<div class="cloudDbull' + obj.id + ' alterbloc' + obj.id + ' unselectable" style="position:absolute;z-index:' + nind + ';';
h += 'background-color:' + BackColor + ';';
h += 'border: solid ' + PenSize + 'px ' + PenColor + ';';
h += 'border-radius: 50%;';
...
if(obj.boite=="clouding"){
var exb=parseInt(obj.getX() * zoom);var eyb=parseInt(obj.getY() * zoom);var wbb=parseInt(obj.getW()  * zoom);var hbb=parseInt(obj.getH() * zoom);var bbu=$("#clouding" + obj.id);
...
var P1x=eachBulles[4];var P1y=eachBulles[5];var P1w=eachBulles[6];var P1h=eachBulles[7];var cloudAbull=$(".cloudAbull" + obj.id);
...
var P2x=eachBulles[8];var P2y=eachBulles[9];var P2w=eachBulles[10];var P2h=eachBulles[11];var cloudBbull=$(".cloudBbull" + obj.id);
...
var P3x=eachBulles[12];var P3y=eachBulles[13];var P3w=eachBulles[14];var P3h=eachBulles[15];var cloudCbull=$(".cloudCbull" + obj.id);
...
var P4x=eachBulles[16];var P4y=eachBulles[17];var P4w=eachBulles[18];var P4h=eachBulles[19];var cloudDbull=$(".cloudDbull" + obj.id);
...
var exb=parseInt(parseInt(obj.getX() - 5) * zoom);var eyb=parseInt(parseInt(obj.getY() - 5) * zoom);var wbb=parseInt(parseInt(obj.getW() + 10) * zoom);
...
bbu.css("left", exb + "px").css("top", eyb + "px");
bbu.fadeIn();
var eachElement=obj.contentpath.split(';');if(mobiSite){
eachElement=obj.contentpathsecond.split(';');
}
var bexb=parseInt(parseInt(eachElement[1]) * zoom);var beyb=parseInt(parseInt(eachElement[2]) * zoom);var bwbb=parseInt(parseInt(eachElement[3]) * zoom);var bhbb=parseInt(parseInt(eachElement[3]) * zoom);var bbulink=$("#linkbbullewhite" + obj.id);
...
var e_x=parseInt(obj.getX() * zoom);var e_y=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var dec=10 * zoom;$("#bulle0_" + obj.id).css("width", (wb /1.5) + "px").css("height", (hb- dec) + "px");
...
var dateString=new Date().toLocaleDateString();try{var dt=new Date();var day=dt.getDate().toString();if(day.length == 1){day='0' + day;}
var mth=parseInt(dt.getMonth()) + 1 ;
if(mth.toString().length == 1){mth='0' + mth.toString();}
var year=dt.getFullYear().toString();dateString=day + '/' + mth +'/' + year;
}catch(err){
}
return dateString;
}
function helperHourActu(){
var dateString='';try{var dt=new Date();var hour=dt.getHours();if(hour<10){hour="0"+hour;}
var min=dt.getMinutes();if(min<10){min="0"+min;}
dateString=hour + 'h' + min;
}catch(err){}
return dateString;
}
var menu_html='';var menu_global='data/page0.xml';var menu_load=0;function installmenu(obj){
var Ecran=document.getElementById("main");var e_x=parseInt(orix) + parseInt(obj.getX() * zoom);
var e_y=parseInt(obj.getY() * zoom);var selectcolor="red";if(obj.selectcolor){
selectcolor=obj.selectcolor;
}
var color="black";if(obj.color){
color=obj.color;
}
var align="center";if(obj.align){
align=obj.align;
}
var h='';var act='';var eachUrl;var eachLabel;var border="none";if(obj.url!=''){
...
var Label=eachLabel[e];var Url  =eachUrl[e];act='';
if(Url!=''){
act=' onclick="loaddata(\'' + Url + '\',\'\');" ';
}
var select ='';var classanim ='menuitem' + obj.id ;
if(menu_global==Url){
...
var borderplus='';if(obj.data=="hori"){
...
var Ecran=document.getElementById("main");var color="black";if(this.color){
color=this.color;
}
var h="";h += '<div style="display:none;color:' + color + ';position:absolute;overflow:auto;' +  obj.cssadd + '" class="unselectable haveflou unselectable bloc' + obj.id + '" unselectable="on" >';
h += obj.text;
h += '</div>';
Ecran.innerHTML=Ecran.innerHTML + h;
obj.oldzoom=0;
...
var h='';var act='';var Ecran=document.getElementById("main");if(obj.type=='contactsimple'){
...
var eventCatchScript=false;var fctMamSlideObject="";function installfx(obj,act){
var h='';var Ecran=document.getElementById("main");if(obj.type=='scriptEvents'){
...
var ind=obj.ind;if(oldTransitionPage=='Slide'){
ind=5;
fctMamSlideObject='$(".topslideobject' + obj.id +'").css("z-index",' + obj.ind + ');';
}
var he=convertToPercentY(obj.getH());h='<div class="mat-shadows-a noslideobject topslideobject' +  obj.id + '" ' ;
...
var col=obj.selectcolor;h='<button id="bloc' + obj.id + '" style="background-color:' + col +  ';' + obj.cssadd + '" ';
...
var ind=obj.ind;var we=(obj.getW() - 31) * zoom;var he=obj.getH() * zoom;h='<div class="mat-shadows-a noslideobject topslideobject' +  obj.id + '" ' ;
...
var exten='.png';var rond="rond.png";if(obj.boite!=''){
boitefond=obj.boite;
...
var omd=act.replace('onclick=','onMouseDown=');h='<img style="position:absolute;cursor:pointer;left:2%;top:2%;width:5px;height:5px;" ';
...
obj.objy=96 * zoom;
obj.border=0;
var zi=11;if(oldnav){zi=0;}
var sens='';if(obj.getX()>840){
sens='-left';
}
...
var animlegend=false;if(obj.option==1){
animlegend=true;
}
...
if(obj.type=='material-top50'){
var we=(obj.getW() - 31) * zoom;$(".topslideobject" + obj.id).css("width",we + "px").css("height",hb + "px");
var radius=31 * zoom;var largW=32 * zoom;if(obj.contenu7==1){
...
var decLeft=parseInt(10 * zoom);if(obj.src!=''){
...
if(obj.type=='infosbulle'){
var fts=parseInt(obj.fontsize * zoom);$("#innertextbulle" + obj.id).css("font-size",fts + "px");
...
if(lastPage0==lpage){
var obj=CObjets[id];eval(obj.text);
if(time>0){
...
var timerPlayer;function playSoundByPlayer(data1,data2,i){
i=parseInt(i);
StopAllSounds();
...
function upBI(i){
var wb=parseInt(CObjets[i].getW() * zoom);var hb=parseInt(CObjets[i].getH() * zoom);var wb_max=parseInt(wb * 1.2);var hb_max=parseInt(hb * 1.2);var dec_x=parseInt((wb_max - wb) / 2 );var dec_y=parseInt((hb_max - hb) / 2 );$('.bloc' + i).stop().animate({width :wb_max + 'px',height :hb_max + 'px',marginLeft :  '-' + dec_x + 'px',marginTop :  '-' + dec_y + 'px' } , 500);
}
function doBI(i){
var wb=parseInt(CObjets[i].getW() * zoom);var hb=parseInt(CObjets[i].getH() * zoom);$('.bloc' + i).stop().animate({width : wb + 'px',height : hb + 'px',marginLeft : '0px',marginTop : '0px' } , 500);
}
function upBL(i){
...
var lw=obj.objx;var lh=obj.objy;if(document.getElementById ("textbulle" + obj.id)){
...
var rati=105/96;lw= parseInt(lh * rati);
obj.objx=lw;
obj.objy=lh;
}else{
obj.border=1;
}
var LittleDecY=(10 * zoom);var leftBul=parseInt(parseInt(e_x -( (lw * zoom)/2 ) )+(wb/2));
if(obj.getX()>840){
...
var parsed=[];parsed=obj.src.split(";");
var legendcoll=[];legendcoll=obj.text.split(";");
if(parsed[actual]!=''){
var srcimg="images/" + parsed[actual];
$('#imgcont' + obj.id ).attr('src', srcimg);
}
var iwe=parseInt(parseInt(obj.getW() * 0.9) * zoom);var ihe=parseInt(parseInt(obj.getH() * 0.8) * zoom);$('#legend' + obj.id ).css("width", parseInt(parseInt(parseInt(obj.getW() * 0.80) * zoom) - 60) + "px");
...
var itw= document.getElementById("imgwork").offsetWidth;var ith= document.getElementById("imgwork").offsetHeight;var ratio=itw/ith;if(ith>itw){
ratio=itw/ith;
...
var parsed=[];parsed=CObjets[i].src.split(";");
...
pointSlide(obj.id);
var iwe=parseInt(parseInt(obj.getW()) * zoom);var ihe=parseInt(parseInt(obj.getH()) * zoom);var ratioH=obj.getH()/200;var vH=parseInt(71*ratioH);var ratioW=obj.getW()/400;var vW=parseInt(61*ratioW);$("#ombreslide" + obj.id ).css("position",'absolute');
...
var ec=0 ;var hauteurF=parseInt(720 * zoom);if(hauteurF<700){ec=7;}
...
var obj=CObjets[id];var actual=parseInt(document.getElementById("numcont" + id).innerHTML);
var parsed=[];parsed=obj.src.split(";");
var iwe=parseInt(parseInt(obj.getW()) * zoom);actual=actual + incr;
...
if(parsed[actual]!=''){
var srcimg="images/" + parsed[actual];
var srcimg2="";if(parsed[actual+ 1]!=''){
...
var obj=CObjets[id];var actual=parseInt(document.getElementById("numcont" + id).innerHTML);
var parsed=[];parsed=obj.src.split(";");
var iwe=parseInt(parseInt(obj.getW()) * zoom);actual=parseInt(actual + parseInt(incr));
if(parsed[actual]==''){actual=0;}
...
var objectifherox=0;var objectifheroy=0;var haveHero=false;var loadaction=0;var angleHero=0;var nextGameTick=80;var FirstGameInit=true;function exitAllGame(){
$("#game").empty();
$('#main').empty();
...
var h='';var act='';var Ecran=document.getElementById("main");if(obj.type=='3dplane'&&obj.objx!=1){
obj.objx=1;
if(FirstGameInit){
...
var extraCss="";if(obj.text.indexOf("gotogreen.gif")!=-1){
...
var srcImg=obj.text;if(cleText(obj.contenu2)!=""){
...
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var ew=parseInt(obj.getW() * zoom);var eh=parseInt(obj.getH() * zoom);var hero_ex=ex - (ew/2);var hero_ey=ey - eh;if(obj.type=='gamehero'){
...
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var ew=parseInt(obj.getW() * zoom);var eh=parseInt(obj.getH() * zoom);if(obj.type=='gamecollide'){
...
function haveCollideObjects(hx,hy){
for(var i=0;i<CObjets_count;i++){
var CtrObj=CObjets[i];var ex=parseInt(CtrObj.getX());var ey=parseInt(CtrObj.getY());var ew=parseInt(CtrObj.getW());var eh=parseInt(CtrObj.getH());var CtrType=CtrObj.type;if(CtrType=='gamecollide'){
...
var act='';if(CtrObj.url!=''){
if(CtrObj.url.indexOf("link:")!=-1){
var ur=CtrObj.url.replace('link:','');act='window.location.href=\'' + ur + '\'; ';
}else{
...
CtrObj.option=1;
if(CtrObj.url!=''){
var HeroCtrObj=trouveHero();CtrObj.setX(-1000);
CtrObj.setY(-1000);
...
if(hx>ex&&hx<parseInt(ex+ew)){
if(hy>ey&&hy<parseInt(ey+eh)){
var HeroCtrObj=trouveHero();CtrObj.setY(-1000);
CtrObj.setX(-1000);
...
var idaction='';var nbClickAct=0;function clickAction(){
if(nbClickAct==0){
nbClickAct++;
return false;
}
var randomnumber=Math.floor(Math.random()*10000);var randomnumber2=Math.floor(Math.random()*10000);var randomnumber3=Math.floor(Math.random()*10000);idaction='idaction' + randomnumber + randomnumber2 + randomnumber3;
var Ecran=document.getElementById("main");eventClickIsoAvatar();
if(haveHero){
var Vobj=trouveHero();if(Vobj){
var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);if(noClickCancel(ex,ey)==false){
objectifherox=ex;
objectifheroy=ey;
correctionZoneAction(objectifherox,objectifheroy);
var angleHero=getAngle(objectifherox,objectifheroy,Vobj.getX(),Vobj.getY());var angleDegrees=angleHero *  (180 /Math.PI) ;var imgsrc=($('.hero' + Vobj.id ).attr("src"));
...
var Vobj= CObjets[i];activeBoule(Vobj);
}
}
}
var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);if(!onObjectClickCancel(ex,ey)){
activeObjectAnimClic();
}
}
function correctionZoneAction(ctrx,ctry){
for(var i=0; i < CObjets_count; i++){
var ob=CObjets[i];if(ob.type=='gamezoneaction'){
var r=0;if(ctrx>parseInt(ob.getX())){
r=r + 1 ;
}
...
for(var i=0; i < CObjets_count; i++){
var ob=CObjets[i];if(ob.type=='videohtml'
||ob.type=='audiohtml'
...
for(var i=0; i < CObjets_count; i++){
var ob=CObjets[i];if(ob.type=='videohtml'||ob.type=='audiohtml'||ob.type=='videodistante'){
var r=0;if(ctrx>parseInt(ob.getX())){
r=r + 1 ;
}
if(ctry>parseInt(ob.getY())){
...
if(idaction==idact){
var Vobj=trouveHero();if(Vobj){
try{if(Vobj.field1==0){
var distx=distancepyta(objectifherox,Vobj.getY(),Vobj.getX(),Vobj.getY());if(distx>5){
...
{}
var interval=(new Date).getTime() - nextGameTick;nextGameTick=(new Date).getTime();
var dist=distancepyta(objectifherox,objectifheroy,Vobj.getX(),Vobj.getY());var deplace=parseInt(parseInt(Vobj.border ) * zoom)* (interval / 80);if(dist>5){
var evolx=parseFloat(Vobj.getX()) +  ((deplace) * Math.cos(angleHero));
var evoly=parseFloat(Vobj.getY());var oneColl=false;if(haveCollideObjects(evolx,evoly)==true){
evolx=parseFloat(Vobj.getX());
evoly=parseFloat(Vobj.getY()) + ((deplace) * Math.sin(angleHero));
}else{
evoly=parseFloat(Vobj.getY()) + ((deplace) * Math.sin(angleHero));
}
if(haveCollideObjects(evolx,evoly)==false){
Vobj.setX(evolx);
Vobj.setY(evoly);
}else{
...
var angleDegrees=angleHero * (180 /Math.PI) ;var imgsrc=($('.hero' + Vobj.id ).attr("src"));
if(Vobj.field1==0){
if(objectifherox>Vobj.getX()){
if(imgsrc.indexOf(Vobj.data)==-1){
$(".hero" + Vobj.id).attr('src',Vobj.data);
...
var delta_x=p2x - p1x;var delta_y=p2y - p1y;var theta_radians= Math.atan2(delta_y, delta_x);return theta_radians;
}
function distancepyta(x1, y1, x2, y2){
var q1=(x1 - x2) * (x1 - x2);var q2=(y1 - y2) * (y1 - y2);return Math.sqrt(q1 + q2);
}
function haveKeyDULR(keycode){
if(haveHero==false){return false;}
var Vobj=trouveHero();var dist=distancepyta(objectifherox,objectifheroy,Vobj.getX(),Vobj.getY());if(dist<5){
var randomnumber=Math.floor(Math.random()*10000);var randomnumber2=Math.floor(Math.random()*10000);var randomnumber3=Math.floor(Math.random()*10000);var distp=50;idaction='idaction' + randomnumber + randomnumber2 + randomnumber3;
switch (keycode){
case 38: //Haut
...
var haveHeroMask=false;var objectHeroMask=false;function installherotarget(obj){
var Ecran=document.getElementById("main");if(obj.type=='gameherotarget'){
if(haveHeroMask){
if(objectHeroMask.idscript==obj.idscript){
obj.text=objectHeroMask.text;
obj.contenu3=objectHeroMask.contenu3;//h
...
var rn=Math.floor(Math.random()*10000);var rn2=Math.floor(Math.random()*10000);var rn3=Math.floor(Math.random()*10000);obj.idstr=rn + rn2 + rn3;
obj.objx=obj.getX();
obj.objy=obj.getY();
obj.border=0;
h='<img style="position:absolute;z-index:2;" ';
h +=' id="bloc' + obj.idstr + '" class="herotarget' + obj.idstr + '" ';
var tobjx=obj.getX();var tobjy=obj.getY();var lengthPts=1;if(obj.de==0){
var parsedPoints=[];parsedPoints=obj.data.split("!");
if(mobiSite){
parsedPoints=obj.contentpathsecond.split("!");
}
if(parsedPoints[parseInt(obj.border)]!=''){
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
...
if(lengthPts==1){
var angleHero=getAngle(obj.getX(),obj.getY(),tobjx,tobjy);var angleDegrees=angleHero *  (180 /Math.PI) ;if(angleDegrees>-45&&angleDegrees<45){
h += ' src="' + obj.contenu4 + '" ';
}else{
h += ' src="' + obj.text + '" ';
}
...
var ids=parseInt($(this).attr('name'));selectPlayerProcess(ids);
});
}
}
}
function selectPlayerProcess(id){
var Splayobj=CObjets[id];if(haveHeroMask==false){
haveHeroMask=true;
...
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var ew=parseInt(obj.getW() * zoom);var eh=parseInt(obj.getH() * zoom);var hero_ex=ex - (ew/2);var hero_ey=ey - (eh/2);$(".herotarget" + obj.idstr).css("left",hero_ex + 'px').css("top",hero_ey + 'px');
$(".herotarget" + obj.idstr).css("width",ew + 'px').css("height",eh + 'px');
}
}
function haveCollideObjectsTarget(hx,hy,idstr){
for(var i=0; i < CObjets_count; i++){
var CtrObj=CObjets[i];var ex=parseInt(CtrObj.getX());var ey=parseInt(CtrObj.getY());var ew=parseInt(CtrObj.getW());var eh=parseInt(CtrObj.getH());var CtrType=CtrObj.type;if(CtrType=='gamezoneaction'){
var act='';if(CtrObj.url!=''){
if(CtrObj.url.indexOf("link:")!=-1){
var ur=CtrObj.url.replace('link:','');act='window.location.href=\'' + ur + '\'; ';
}else{
...
var nbpts=parseInt(parsedPoints.length);if(obj.border==''){obj.border='0';}
if(parseInt(obj.border)<nbpts){
if(parsedPoints[parseInt(obj.border)]!=''){
if(document.getElementById("bloc" + obj.idstr)){
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
var wb=parseInt(obj.getW()/2);var hb=parseInt(obj.getH()/2);var xm=parseInt(parsedPt[0]);var ym=parseInt(parsedPt[1]);if(xm>(largEcranWidth-3)){
xm=largEcranWidth + parseInt(obj.getW()/1.5);
}
if(xm<3){
xm=parseInt(obj.getW()/1.5) * -1;
}
var xanim=parseInt(xm);var yanim=parseInt(ym);obj.objx=xanim;
obj.objy=yanim;
...
var angleHero=0;try{angleHero=getAngle(obj.getX(),obj.getY(),obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.getX(),obj.getY());var deplace=parseInt(8 * zoom);var distCtr=parseInt(parseInt(obj.align) + 2);
if(distCtr<5){distCtr=5;}
if(dist>distCtr){
var deplace=parseInt(parseInt(obj.align) * zoom);var evolx=parseFloat(obj.getX()) + ((deplace) * Math.cos(angleHero));
...
obj.setY(evoly);
zoomGametarget(obj);
var angleDegrees=angleHero *  (180 /Math.PI) ;var imgsrc=$('.herotarget' + obj.idstr ).attr("src");
var newimg='';if(obj.objx>obj.getX()){
newimg=obj.contenu4;
}
...
var nind=parseInt(obj.ind);var h='';var color="black";if(obj.color){color=obj.color;}
var Ecran=document.getElementById("main");var rn=Math.floor(Math.random() * 100);obj.idstr=rn + '-' + obj.idscript ;
...
var parsedPoints=[];parsedPoints=obj.contenu2.split("!");
if(mobiSite){
parsedPoints=obj.contentpathsecond.split("!");
}
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
var xanim=parseInt(parsedPt[0]);var yanim=parseInt(parsedPt[1]);obj.objx=xanim;
obj.objy=yanim;
if(obj.an!=1){
...
var rn=Math.floor(Math.random() * 100);obj.idstr=rn + 'circletarget';
var h='<img style="position:absolute;';h=h + 'left:-100px;top:-150px;width:50px;height:50px;z-index:' + nind + ';" ';
h=h + ' id="circletarget' + obj.idstr + '" class="unselectable circletarget' + obj.idstr + '" ';
...
var obj=CObjets[parseInt(i)];if(obj.type=='fluxitems'){
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb/2);var tobjtarget=$(".targetflux" + obj.idstr);
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
tobjtarget.css("left",lt_ex + 'px').css("top",lt_ey + 'px');
var valfontsize=parseInt(obj.fontsize * zoom);$("#targetfluxinner" + obj.id).css("font-size",valfontsize + 'px');
}
}
function zoomfluxitemsY(i){
var obj=CObjets[parseInt(i)];var ey=parseInt(obj.getY()* zoom);var hb=parseInt(obj.getH() * zoom);var lt_ey=ey - (hb/2);$(".targetflux" + obj.idstr).css("top",lt_ey + 'px');
}
function firstanimfluxitemstID(i){
var obj=CObjets[parseInt(i)];var objTarget=$('.targetflux' + obj.idstr);
objTarget.css("display", "");
animfluxitems(i);
}
function animfluxitemstID(i){
var obj=CObjets[parseInt(i)];animfluxitems(i);
}
function animfluxitems(i){
var obj=CObjets[parseInt(i)];if(typeof(obj)=='undefined'){return false;}
if(!document.getElementById('targetflux' + obj.idstr)){
return false;
}
if(obj.type=='fluxitems'){
var objTarget=$('.targetflux' + obj.idstr);
var times=50;if(parseInt(obj.negnote)==1){
objTarget.css("margin-top", "-1350px");
}
var fluxitemstag23=0;var angleItems=0;try{angleItems=getAngle(obj.getX(),obj.getY(),obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.getX(),obj.getY());var deplace=parseInt(10);if(dist>10){
if(document.getElementById('targetflux' + obj.idstr)){
...
var evolx=parseFloat(obj.objx);var evoly=parseFloat(obj.objy);obj.setX(evolx);
obj.setX(evoly);
CObjets[obj.id].setX(parseFloat(evolx));
CObjets[obj.id].setY(parseFloat(evoly));
zoomfluxitems(i);
...
var nbpts=parseInt(parsedPoints.length);obj.border=parseInt(parseInt(obj.border) + 1);
...
var obj=CObjets[parseInt(i)];var parsedPoints=[];parsedPoints=obj.contenu2.split("!");
if(mobiSite){
parsedPoints=obj.contentpathsecond.split("!");
}
obj.border=0;
var parsedStart=[];parsedStart=obj.contenu3.split(";");
if(mobiSite){
parsedStart=obj.contenu6.split(";");
}
var xStart=parseInt(parsedStart[0]);var yStart=parseInt(parsedStart[1]);obj.setX(parseInt(xStart));
obj.setY(parseInt(yStart));
CObjets[obj.id].setX(parseInt(xStart));
CObjets[obj.id].setY(parseInt(yStart));
zoomfluxitems(i);
var parsedPt=[];parsedPt=parsedPoints[0].split(";");
var xanimobj=parseInt(parsedPt[0]);var yanimobj=parseInt(parsedPt[1]);obj.objx=xanimobj;
obj.objy=yanimobj;
zoomfluxitems(i);
appltextfluxitem(i);
}
function appltextfluxitem(i){
var obj=CObjets[parseInt(i)];if(obj.contenu4!=''){
if(obj.contenu4.indexOf(';')==-1){
var nh=obj.contenu4;$("#targetfluxinner" + obj.id).html(nh);
}else{
var parsedText=[];parsedText=obj.contenu4.split(";");
var r=Math.floor(Math.random() * parsedText.length);var nh=parsedText[r];$("#targetfluxinner" + obj.id).html(nh);
}
}
var ra=parseInt(Math.floor(Math.random() * 10));if(ra<5){
...
var objC=CObjets[parseInt(j)];for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='gamechangeimages'){
var ex=parseInt(obj.getX());var ey=parseInt(obj.getY());var ew=parseInt(obj.getW());var eh=parseInt(obj.getH());if(hx>ex&&hx<parseInt(ex+ew)){
if(hy>ey&&hy<parseInt(ey+eh)){
...
var func1=window[func];if(typeof func1 === 'undefined'){
return false
}else{
return true;
}
...
var obj=CObjets[parseInt(i)];var objTarget=$('.circletarget' + obj.idstr);
objTarget.css("display", "");
animCircleTarget(i);
}
function animCircleTarget(i){
var obj=CObjets[parseInt(i)];var tim=50;if(typeof(obj)=='undefined'){return false;}
if(!document.getElementById('circletarget' + obj.idstr)){
return false;
}
var rayonW=obj.getW();var rayonH=obj.getH();var evolx=parseFloat(obj.getX()) + ((rayonW) * Math.cos(obj.border));
var evoly=parseFloat(obj.getY()) + ((rayonH) * Math.sin(obj.border));
var wb=parseInt(parseInt(obj.contenu2) * zoom);var hb=parseInt(parseInt(obj.contenu3) * zoom);var b=collideImageChangeCT(i,evolx,evoly);if(obj.option==1||obj.option=='1'){
if(b){
tim=1000;
}
}
var ex=parseInt(evolx * zoom) - (wb/2);var ey=parseInt(evoly * zoom) - (hb/2);var tobjtarget=$("#circletarget" + obj.idstr);
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
tobjtarget.css("left",ex + 'px').css("top",ey + 'px');
var speed=parseInt(obj.text)/100;if(obj.option2==1||obj.option2=='1'){
...
var oldSrc=ob.attr('src');if(oldSrc.indexOf(obj.src)==-1){
ob.attr('src', obj.src);
return true;
}
}
...
var EquipMapTarg=-1;var EquipMapMAX=0;var InitialMapTarget=[0, 0, 0, 0];var ObjectifMapTarget=[0, 0, 0, 0];var RunMapDice=false;var RunActionDice=false;function installMapTarget(obj){
...
var nind=parseInt(obj.ind);var h='';var Ecran=document.getElementById("main");var rn=Math.floor(Math.random() * 10000);obj.idstr=rn + '-' + obj.idscript ;
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);h += '<img style="position:absolute;';
...
var initmt=parseInt(InitialMapTarget[parseInt(obj.contenu6)]);if(typeof(initmt) === "undefined" ||  isNaN(initmt)){
InitialMapTarget=[0, 0, 0, 0];
ObjectifMapTarget=[0, 0, 0, 0];
initmt=parseInt(InitialMapTarget[parseInt(obj.contenu6)]);
}
var pars=parsedPoints[initmt];var parsedPt=[];parsedPt=pars.split(";");
var xanim=parseInt(parsedPt[0]);var yanim=parseInt(parsedPt[1]);if(parseInt(obj.contenu6)==1){
xanim=xanim - 5;
yanim=yanim - 5;
}
obj.setX(xanim);
...
if(obj.type=='mapdes'){
var Ecran=document.getElementById("main");var h='';h=h + '<img ';
...
if(RunMapDice==false){
var obj=CObjets[parseInt(i)];$('#bloc' + i ).attr('src',obj.contenu2);
RunMapDice=true;
$( "#bloc" + i ).animate({
marginTop: "-250px"
}, 500, function(){
...
var valDice=parseInt(num);if(obj.contenu3!=''){
var reInitDices=false;eval(obj.contenu3);
if(reInitDices){
RunMapDice=false;
}
}else{
...
var obj=CObjets[parseInt(i)];if(obj.type=='maptarget'){
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb);var tobjtarget=$("." + obj.contenu6 + "targetMap" + obj.idstr);
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
tobjtarget.css("left",lt_ex + 'px').css("top",lt_ey + 'px');
}
}
function firstanimMapTargetID(i){
var obj=CObjets[parseInt(i)];var objTarget=$("." + obj.contenu6 + "targetMap" + obj.idstr);
objTarget.css("display", "");
var ctr1=parseInt(ObjectifMapTarget[obj.contenu6]);var ctr2=parseInt(InitialMapTarget[obj.contenu6]);if(ctr1<ctr2){
reculeMapTargetID(i);
...
var obj=CObjets[parseInt(i)];var ctr1=parseInt(ObjectifMapTarget[obj.contenu6]);var ctr2=parseInt(InitialMapTarget[obj.contenu6]);if(ctr1<ctr2){
var objTarget=$("." + obj.contenu6 + "targetMap" + obj.idstr);
var parsedPoints=[];parsedPoints=obj.contenu2.split("!");
if(mobiSite){
parsedPoints=obj.contentpathsecond.split("!");
}
var itemid=parseInt(obj.contenu6);var itempts=parseInt(ObjectifMapTarget[itemid]);var parsedPt=[];parsedPt=parsedPoints[itempts].split(";");
var xanim=parseInt(parsedPt[0]);var yanim=parseInt(parsedPt[1]);obj.setX(xanim);
obj.setY(yanim);
obj.objx=xanim;
obj.objy=yanim;
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb);InitialMapTarget[obj.contenu6]=ObjectifMapTarget[obj.contenu6];
objTarget.animate({
left: lt_ex + "px" ,
top:  lt_ey + "px"
}, 1000, function(){
...
var obj=CObjets[parseInt(i)];animMapTarget(i);
}
function animMapTarget(i){
var obj=CObjets[parseInt(i)];var continu=true;if(typeof(obj)=='undefined'){return false;}
if(!document.getElementById(obj.contenu6 + 'targetMap' + obj.idstr)){
continu=false;
return false;
}
if(obj.type=='maptarget'){
var times=50;var angleItems=0;try{angleItems=getAngle(obj.getX(),obj.getY(),obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.getX(),obj.getY());var deplace=parseInt(10);if(dist>10){//distance
if(document.getElementById(obj.contenu6 + 'targetMap' + obj.idstr)){
var deplace=parseInt(parseInt(obj.align));var evolx=parseFloat(obj.getX()) + ((deplace) * Math.cos(angleItems));
var evoly=parseFloat(obj.getY()) + ((deplace) * Math.sin(angleItems));
obj.setX(evolx);
obj.setY(evoly);
...
var nbpts=parseInt(parsedPoints.length);if(parseInt(InitialMapTarget[EquipMapTarg])>parseInt(nbpts)
||parseInt(InitialMapTarget[EquipMapTarg])==parseInt(parseInt(nbpts)-1)){
var parsedActions=[];parsedActions=obj.contenu4.split("!");
RunActionDice=false;
...
var parsedActions=[];parsedActions=obj.contenu4.split("!");
RunActionDice=false;
var num=parsedActions[ObjectifMapTarget[EquipMapTarg]];if(obj.option3==0||obj.option3=='0'){
...
var parsedPt=[];var pointCtr=parsedPoints[parseInt(InitialMapTarget[EquipMapTarg])];if(pointCtr){
parsedPt=pointCtr.split(";");
var xanim=parseInt(parsedPt[0]);var yanim=parseInt(parsedPt[1]);if(EquipMapTarg==1){
xanim=xanim - 5;
yanim=yanim - 5;
}
obj.objx=xanim;
...
var execTimerOK=0;function installSimulBloc(obj){
if(obj.type=='simulBloc'){
var Ecran=document.getElementById("main");var h='';h += '<img style="display:none;position:absolute;border:solid 1px gray;';
...
var anglei=0;try{anglei=getAngle(ix,iy,parseInt(obj.contenu5),parseInt(obj.contenu6));
obj.evol=anglei;
}catch(err){}
if(obj.option==1){
...
var Ecran=document.getElementById("main");obj.evol=0;
var h='';h=h + '<img style="position:absolute;';
...
for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='simulItem'){
if(obj.evol==0){
var deplace=4;var angleItems=parseFlo(obj.text);var evolx=parseFloat(obj.getX()) + (deplace * Math.cos(angleItems));
var evoly=parseFloat(obj.getY()) + (deplace * Math.sin(angleItems));
...
if(obj.evol==2){
var deplace=4;var dist=distancepyta(obj.objx,obj.objy,obj.getX(),obj.getY());if(dist>6){
var angleItems=parseFlo(getAngle(obj.getX(),obj.getY(),obj.objx,obj.objy));var evolx=parseFloat(obj.getX()) + (deplace * Math.cos(angleItems));
var evoly=parseFloat(obj.getY()) + (deplace * Math.sin(angleItems));
obj.setX(parseInt(evolx));
obj.setY(parseInt(evoly));
CObjets[obj.id].setX(parseInt(evolx));
...
for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='simulItem'){
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var lt_ex=ex - (wb/2);var lt_ey=ey - (hb/2);var tobjtarget=$(".simulItem" + obj.id);
tobjtarget.css("left",lt_ex + 'px').css("top",lt_ey + 'px');
tobjtarget.css("width",wb + 'px').css("height",hb + 'px');
}
}
...
var simulBlocTemp=findObjectLibreItem();var simulBlocT=new CObjet();if(simulBlocTemp!=false){
...
var objC=CObjets[parseInt(j)];for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='simulBloc'){
var ex=parseInt(obj.getX());var ey=parseInt(obj.getY());var ew=parseInt(obj.getW());var eh=parseInt(obj.getH());if(hx>ex&&hx<parseInt(ex+ew)){
if(hy>ey&&hy<parseInt(ey+eh)){
...
var Ecran=document.getElementById("main");obj.fields=(obj.field1 + '||||||||').split('|');
var h='';var fct=obj.type.replace('plugin-','');fct=fct.replace('plugques-','');
var namePlgFct=fct ;var fctstrCtr=fct + 'OnPaint';
...
var h='';var fct=obj.type.replace('plugin-','');fct=fct.replace('plugques-','');
fct=fct + 'OnZoom(obj)';
var fctstrCtr=fct.replace('(obj)','');if(typeof window[fctstrCtr] === "function"){
eval(fct);
}
}
}
...
if(obj.type.indexOf('plugin-')!=-1
||obj.type.indexOf('plugques-')!=-1){
var ret=false;var fct=obj.type.replace('plugin-','');fct=fct.replace('plugques-','');
...
if(obj.type.indexOf('plugques-')!=-1){
var ret='';var fct=obj.type.replace('plugques-','');fct='ret=' + fct + 'SendObjMemory(obj)';
eval(fct);
return ret;
}else{
return '';
...
if(obj.type.indexOf('plugques-')!=-1){
var ret='';var fct=obj.type.replace('plugques-','');fct='ret=' + fct + 'RetrieveObjMemory(obj,\'' + mem + '\')';
eval(fct);
return ret;
}else{
return '';
...
execScriptLoop();
var h='<input style="position:absolute;z-index:10;" ';var texteValue=obj.text;if(texteValue.indexOf("==")!=-1){
try{texteValue=texteValue.replace('==','');
...
var h='<div style="position:absolute;border:solid 1px black;cursor:text;background:white;" ';h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" onKeyUp="execScriptLoop();eventCatchScript=true;" ';
h += ' >';
h += '</div>';
addToM(h);
...
var h='<div style="position:absolute;border:solid 2px black;cursor:text;background:white;" ';h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
...
h += '>';
var eachElement=obj.field1.split(';');for(var e=0 ; e < eachElement.length; e++){
var reponse=eachElement[e];if(reponse!=''){
var tmpId=obj.id + 'a' + e + 't' + reponse.length; ;
var reponseLoad=reponse.replace('\'','apostrophe');reponseLoad=reponseLoad.replace('\'','apostrophe');
...
var xb=parseInt(parseInt(obj.getX() - 2) * zoom);var yb=parseInt(parseInt(obj.getY() + 2) * zoom);
var hb=parseInt(obj.getH() * zoom);var wb=parseInt(parseInt(obj.getW() + 12) * zoom);
...
var f=0;var valInput=document.getElementById('input' + id).value.toLowerCase();
var arr=new Array();arr=document.getElementsByTagName('tr');
for(var i=0; i < arr.length; i++){
var att=arr[i].getAttribute("name");var ctr='search' + id;
if(att==ctr){
var obj=arr[i];var Vobj=document.getElementById(obj.id);if(valInput==''){
Vobj.style.display="none";
}else{
var ctr2=Vobj.getAttribute("data-string");if(ctr2.toLowerCase().indexOf(valInput)!=-1){
Vobj.style.display="";
f=1;
}else{
Vobj.style.display="none";
...
var IntervalClock =0;var clockId='';var clockAct='';var clockTimeI=20;var clockImage=1;var clockBoite='';var clockFct='';var clockTimerG=0;function installclock(obj,act){
var h='';clockAct='';
IntervalClock=0;
clockBoite=obj.boite;
var timeI=parseInt(obj.text);if(obj.contenu4!=''){
if(typeof window[obj.contenu4]!== 'undefined'){
timeI=window[obj.contenu4];
}
}
clockTimeI=timeI;
var timeG=parseInt(1000);var randomnumber=Math.floor(Math.random()*10000);var randomnumber2=Math.floor(Math.random()*10000);var randomnumber3=Math.floor(Math.random()*10000);clockId='clocktimer' + obj.id + randomnumber + randomnumber2 + randomnumber3;
clockImage=1;
var decy='';if(obj.getW()<35||obj.an==18){
...
var timeInter=timeI/25;timeG=parseInt(timeInter);
clockTimerG=timeG;
...
var globalCompteurTimer=false;var globalCompteurTimerSecond=0;var globalCompteurTimerDepart=0;var globalCompteurTimerEnd=0;var globalCompteurDecompt=false;var globalCompteurEndScreen=0;var globalCompteurDisplay="<b>00:00:00</b>";function installclockcompteur(obj,act){
var Ecran=document.getElementById("main");var cssPlus="";if(obj.css){
cssPlus=obj.css ;
}
var color="black";if(obj.color){
color=obj.color;
}
var h='';h='<table style="padding:0;margin:0;position:absolute;' + cssPlus + '" ';
h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '"  ';
...
var ht=(new Date()).getTime() - globalCompteurTimerDepart;globalCompteurDisplay='<b>' + MillisecondsToTimeForCompteur(ht) + '</b>';
$(".blocTimerCompteur").html(globalCompteurDisplay);
}
}
}
...
var S=Seconds % 60;Seconds -= S;
if(S < 10){S='0' + S;}
var M=(Seconds / 60) % 60;if(M < 10){M='0' + M;}
var H=Math.floor(Seconds / 3600);if(H < 10){H='0' + H;}
return H + ':' + M + ':' + S;
}
var filedata='';var activeNoeud=0;var loadReponses='<img class="loaderajaxdialog" style="margin-top:10px;margin-bottom:10px;" src="css/ajax_loader_orange.gif" />';var sensRep=0;var dialogId=0;var dialogObjId=0;var dialogObjIdUnik='';var dialogQuest="";function instalDialog(obj){
var Ecran=document.getElementById("main");var color="black";if(obj.color){
color=obj.color;
}
if(obj.type=='ludidialog'){
var h='';var ht=getBoite(obj);if(ht!=''){
h=h + ht;
}
dialogObjId=parseInt(obj.id);
var rn=Math.floor(Math.random() * 100);dialogObjIdUnik='zonereponsesdialog' + rn + dialogObjId;
h=h + '<table style="display:none;color:' + color + ';" ';
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' >';
h=h + '<tr><td id="zonedialogtexte" class="zonereponsesdialog" style="text-align:center;color:' + color + ';" >';
h=h + convertDiaToHtml(obj.text);
h=h + '</td>';
obj.bilan='';
obj.bilandisplay='';
...
h=h + '<td id="' + dialogObjIdUnik + '" class="zonereponsesdialog" style="width:30%;" ';
h=h + ' >' + loadReponses + '</td></tr>';
sensRep=1 ;
}else{
h=h + '</tr><tr><td id="' + dialogObjIdUnik + '" class="zonereponsesdialog" ';
h=h + ' style="height:20%;" >';
h=h + loadReponses + '</td></tr>';
sensRep=0 ;
}
...
h=h + '<table style="color:' + color + ';" ';
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' >';
h=h + '<tr><td id="' + dialogObjIdUnik + '" class="zonereponsesdialog" style="text-align:center;color:' + color + ';" >';
h=h + '</td></tr></table>';
Ecran.innerHTML=Ecran.innerHTML + h;
}
}
function loadDialog(data,localx){
var d=new Date();var n=d.getMinutes();if(localExec()){
data=doff[localx];
opendialogXML(data);
...
var h='';if(!document.getElementById(dialogObjIdUnik)){
return false;
}
...
h=h + createButtonDialogue(CDialogs[i].idChoix1,CDialogs[i].lienChoix1,i,CDialogs[i].noteChoix1);
}
if(CDialogs[i].idChoix2.length>5){
h=h + createButtonDialogue(CDialogs[i].idChoix2,CDialogs[i].lienChoix2,i,CDialogs[i].noteChoix2);
}
if(CDialogs[i].idChoix3.length>5){
h=h + createButtonDialogue(CDialogs[i].idChoix3,CDialogs[i].lienChoix3,i,CDialogs[i].noteChoix3);
}
if(CDialogs[i].idChoix4.length>5){
h=h + createButtonDialogue(CDialogs[i].idChoix4,CDialogs[i].lienChoix4,i,CDialogs[i].noteChoix4);
}
if(CDialogs[i].idChoix5.length>5){
h=h + createButtonDialogue(CDialogs[i].idChoix5,CDialogs[i].lienChoix5,i,CDialogs[i].noteChoix5);
}
if(document.getElementById(idUnik)){
document.getElementById(idUnik).innerHTML=h;
}else{
setTimeout('afficheChoices(0,"' + idUnik + '");',1500);
}
...
var h='';var formatl=l;var escapedString=formatl.replace(/'/g, "&apos;").replace(/"/g, "&quot;");escapedString=escapedString.replace(/'/g, "&apos;").replace(/"/g, "&quot;");
...
var noteReponse=parseFlo(CDialogs[numid].note);if(noteReponse>0){
...
var dialogBloc=new CObjet();dialogBloc.id=idstr + '00' + numid;
...
var bhtml='<div class="blockbilan" ><div class="questbilan" ><span style="color:green;" >&#9632;&nbsp;</span> Dialogue</div>';bhtml += '<ul>' + dialogQuest + '</ul>';
bhtml += '<ul style="color:green;" ><i>&quot;' + libelle + '&quot;</i></ul>';
bhtml += '</div>';
}else{
var bhtml='<div class="blockbilan" ><div class="questbilan" ><span style="color:orange;" >&#9632;&nbsp;</span> Dialogue</div>';bhtml += '<ul>' + dialogQuest + '</ul>';
...
document.getElementById("zonedialogtexte").innerHTML=loadReponses;
var ri=-1;for(var i=0; i < CDialog_count; i++){
...
if(document.getElementById("zonedialogtexte")){
var diaHTML =convertDiaToHtml(CDialogs[ri].text);if(noteReponse>0){
var Vobj=CObjets[dialogObjId];Vobj.bilan =Vobj.bilan + "<answer>";
...
document.getElementById("zonedialogtexte").innerHTML=diaHTML;
dialogQuest=diaHTML;
setTimeout('afficheChoices(' + ri + ',"' + dialogObjIdUnik + '");',1500);
if(CDialogs[ri].linkScript!=''){
var scr=detectScriptToEval(CDialogs[ri].linkScript);try{eval(scr);
} catch (e){
alert(scr);
...
var CDialogs=new Array();var CDialog_count=0;function CDialogs_Add(Elem){
...
CDialogs=new Array();
CDialog_count=0;
var nbcharge=0;var xml_p;if(typeof data == "string"){
xml_p=StringtoXML(data);
}else{
xml_p=data;
}
$(xml_p).find('dialog').each(function(){
var tempBloc=new CDialog();tempBloc.idstr=$(this).find('id').text();
...
var hiddenZoneFakeClicked=0;var hiddenZoneLastWord="";function installludi(obj){
var h='';var act='';var color="black";if(obj.color){
color=obj.color;
}
if(obj.url!=''){
if(obj.url.indexOf("link:")!=-1){
var ur=obj.url.replace('link:','');act=' onClick="window.location.href=\'' + ur + '\';return false;" ';
}else{
act=' onclick="loaddata(\'' + obj.url + '\',\'' + obj.data + '\');" ';
}
}
var Ecran=document.getElementById("main");if(obj.type=='luditarget'){
var parsedIMG=[];parsedIMG=obj.text.split(";");
var rn=Math.floor(Math.random()*10000);var rn2=Math.floor(Math.random()*10000);var rn3=Math.floor(Math.random()*10000);obj.idstr=rn + rn2 + rn3;
...
var escapedString=obj.text.replace(/'/g, " ").replace(/"/g, " ");h += ' onClick="$(\'#zonebloc' + obj.id + '\').fadeIn();hiddenZoneLastWord=\'' + escapedString + '\';" ';
h += '></span>';
...
var nb  =parseInt(obj.border);if(nb>1){
h += '<img style="position:absolute;left:0px;top:0px;width:50px;height:50px;display:none;z-index:2;" ';
...
h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h += '>';
var wi=parseInt(obj.border);var he=parseInt(obj.note);var libelles=obj.text.split('|');var rptcolors=obj.data.split(';');for(var i=0; i<parseInt(obj.src); i++){
if(libelles[i]!=''){
var pourc=0;if(domainesN_F[i]!=0&&domainesN_T[i]!=0){
...
var resultD=Math.round(domainesN_F[i]*10)/10;h += resultD + '/' + domainesN_T[i];
h += '</div></div>';
...
var adress=obj.text;adress=adress + '?ps=' + obj.contenu2;
if(obj.option==1){
...
var obj=CObjets[i];var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);if(document.getElementById("cascadeActivator" + obj.idstr)){
...
var nb=parseInt(obj.border);var tps =parseInt(obj.note);var valu=tps / nb;animcascade(obj,tps,1,10);
if(nb==2){
...
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);if(obj.type=='luditarget'){
...
if(obj.type=='ludirpt'){
var wi=parseInt(obj.border * zoom);var he=parseInt(obj.note * zoom);$(".gauge" + obj.id).css("width",wi + 'px').css("height", he + 'px');
wi=wb - wi;
...
var size=$(this).attr('data-size');var wsize=parseInt(wi *0.9) * size;$(this).animate({width : wsize + 'px'},2000);
});
var ht=$(".notegauge").height();var lht=parseInt(parseInt(parseInt(he *0.7) - ht)/2);$(".notegauge").css("margin-top",lht);
$(".notegauge").fadeIn("slow");
$(".notegauge").animate({marginRight : lht + 'px'},2500);
}
if(obj.type=='holetext'||obj.type=='tcm'){
var nt=parseInt(parseInt(obj.fontsize * zoom) * 0.7);if(nt<14){nt='14';}
$('#bloc' + obj.id + ' .reponseholetext').each(function(index){
var idctr=$(this).attr('id');if(document.getElementById(idctr)){
...
var html="";for(var i=0; i < CObjets_count; i++){
...
var parsedPoints=[];parsedPoints=obj.data.split("!");
var parsedTime=[];parsedTime=obj.remarque.split(";");
var parsedIMG=[];parsedIMG=obj.text.split(";");
var nbpts=parseInt(parsedPoints.length);if(obj.border==''){obj.border='0';}
if(parseInt(obj.border)<nbpts){
if(parsedPoints[parseInt(obj.border)]!=''){
var parsedPt=[];parsedPt=parsedPoints[parseInt(obj.border)].split(";");
var wb=parseInt(obj.getW()/2);var hb=parseInt(obj.getH()/2);var xanim=parseInt(parseInt(parsedPt[0]) - wb) * zoom;var yanim=parseInt(parseInt(parsedPt[1]) - hb) * zoom;var timep=parseInt(parsedTime[parseInt(obj.border)]);$("#targetbloc" + obj.idstr).animate({
...
var parsedPoints=[];parsedPoints=obj.remarque.split(";");
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW()/2);var hb=parseInt(obj.getH()/2);var xanim=parseInt(parseInt(parsedPoints[0]) - wb) * zoom;var yanim=parseInt(parseInt(parsedPoints[1]) - hb) * zoom;if(parseInt(obj.selectcolor)!=0){
var zone=parseInt(obj.selectcolor) * zoom;xanim=parseInt(xanim - zone) + parseInt( Math.floor( Math.random() * (zone*2) ));
...
var AutoLockObjets=0;function placeLockObjets(obj){
return false;
}
...
var timeoutHW;var actualObjHW;function launchHandWriting(id){
var obj=CObjets[id];actualObjHW=id;
var sid=".bloc" + id +",.alterbloc" + id;
$(sid).css({ opacity : 0});
$(sid).css("margin-top", "0px");
window.clearTimeout(timeoutHW);
var i=0;addHandWritingImg();
var xObj=parseInt(obj.getX() * zoom);var yObj=parseInt(obj.getY() * zoom);var fontSizeObj=parseInt(obj.fontsize * zoom);var lgtObj=($('#innerbloc' + id + " p").length);
if(lgtObj>0){
...
if(textObj.length > 0){
var timeSteps=70;var next=textObj.match(/(\s*(<[^>]*>)?)*(&.*?;|.?)/)[0];textObj=textObj.substr(next.length);
...
var of1=p.position();var of2=$(selfObj).position();var rdm=Math.floor(Math.random() * fontSizeObj)
if(actualObjHW==id){
$("#handpencil").animate({
...
var obj=CObjets[id];var timeH=200;var xP=0.1;var yP=0.45;var sid=".bloc" + id +",.alterbloc" + id;
...
var h="<img id='handpencil' ";h=h + "style='position:absolute;left:1500px;top:1500px;width:750px,height:750px;z-index:4;' ";
...
var obj=CObjets[id];var xObj=parseInt(obj.getX() + ((obj.getW()/2)*0.85)) * zoom;
...
var obj=CObjets[id];var xObj=parseInt(obj.getX() + ((obj.getW())*0.90)) * zoom;
...
var obj=CObjets[id];var xObj=parseInt(obj.getX() + ((obj.getW())*0.75)) * zoom;
...
var obj=CObjets[id];var xObj=parseInt(obj.getX() + ((obj.getW())*0.16)) * zoom;
...
var ObjDrag=-1;var EcranDrag ;var EcranDragX;var EcranDragY;var attentePlace=0;function installdragdrop(obj){
if(obj.type=='drag'||obj.type=='dragslide'){
obj.objx=obj.getX();
obj.objy=obj.getY();
}
recupDataObjectMem(obj,lastPage0);
var h='';var act='';if(obj.url!=''){
if(obj.url.indexOf("link:")!=-1){
var ur=obj.url.replace('link:','');act=' onClick="window.location.href=\'' + ur + '\';return false;" ';
}else{
act=' onclick="loaddata(\'' + obj.url + '\',\'' + obj.data + '\');" ';
...
var Ecran=document.getElementById("main");var cursorA='cursor:move;';if(forkDragDrop==1||exceptionForkDragDrop){
...
if(obj.type=='drag'||obj.type=='dragslide'){
var event='';if(obj.idscript=='ludiscapelinks'){
var decx=parseInt(parseInt(obj.getW() * zoom)/2);var decy=parseInt(parseInt(obj.getH() * zoom)/2);var ox=parseInt(obj.getX() * zoom) + decx;
...
var drgevent=' draggable="true"  ';if(navigator.userAgent.toUpperCase().indexOf("CHROME") != -1){
...
var bilansource='';if(obj.contenu5!=''){
...
var fctEm=obj.type.replace('plugin-','');fctEm= fctEm + 'OnEndMove';
if(typeof window[fctEm]  == 'function'){
fctEm=fctEm +'(CObjets[' + obj.id + ']);'
}else{fctEm='';}
var Ecran=document.getElementById("main");var event='';var cursorA='cursor:move;';if(forkDragDrop==1||exceptionForkDragDrop){
cursorA='cursor:pointer;';
}
if(forkDragDrop==1||exceptionForkDragDrop){
event =event + ' onClick="onStartDragFork(' + obj.id + ');" ';
...
if(obj.onmove!=1){
var xb=parseInt(obj.getX() * zoom) - 5;var yb=parseInt(obj.getY() * zoom) - 5;var wb=parseInt(obj.getW() * zoom) + 10 ;
...
var scdd=CObjets[i].extracont;eval(scdd);
}
}
return true;
}
...
attentePlace=0;
var nx=CObjets[i].getX();var ny=CObjets[i].getY();if(document.getElementById('table' + i)){
...
if(ViewerAfterBilan){return false;}
var nx=CObjets[j].getX();var ny=CObjets[j].getY();var nw=CObjets[j].getW();var nh=CObjets[j].getH();var dejaplace=false;for(var i=0; i < CObjets_count; i++){
...
if(ViewerAfterBilan){return false;}
var nx=CObjets[j].getX();var ny=CObjets[j].getY();var dejaplace=false;for(var i=0; i < CObjets_count; i++){
if(j!=i){
...
var nx=CObjets[i].getX();var ny=CObjets[i].getY();CObjets[ObjDrag].setX(nx);
...
var VobjDrag=CObjets[ObjDrag];var VobjDrop=CObjets[i];if(VobjDrop.data!=VobjDrag.data){
if(VobjDrag.option==1){
VobjDrag.setX(parseInt(VobjDrag.objx));
VobjDrag.setY(parseInt(VobjDrag.objy));
var jnx=VobjDrag.getX();var jny=VobjDrag.getY();animplaceObj(ObjDrag,jnx,jny);
...
if(ObjDrag!=-1){
if(EcranDrag){
var i=parseInt(ObjDrag);var ex=parseInt(xcoord - EcranDragX) - parseInt(parseInt(CObjets[i].getW() * zoom)/2);if(CObjets[i].type=='dragslide'){
var x1=parseInt(ex / zoom);var x2=parseInt(CObjets[i].objx);if(x1 < x2){
ex=(CObjets[i].objx) * zoom;
CObjets[i].setX(CObjets[i].objx);
}
var x3=parseInt(CObjets[i].text);if(x1 > (x2 + x3)){
...
var actiony=true;if(CObjets[i].type=='dragslide'){actiony=false;}
var ey=0;if(actiony){
...
var decx=parseInt(parseInt(CObjets[i].getW() * zoom)/2);var decy=parseInt(parseInt(CObjets[i].getH() * zoom)/2);var lx=parseInt(CObjets[i].objx * zoom) + decx;
...
function nearDrag(j){
try{if(ViewerAfterBilan){return false;}
var objDrag=CObjets[j];if(objDrag){
var ctrx=parseInt(objDrag.getX() + (objDrag.getW()/ 2));
var ctry=parseInt(objDrag.getY() + (objDrag.getH()/ 2));
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='drop'||CObjets[i].type=='bag'){
var r=0;if(ctrx>parseInt(CObjets[i].getX())){
r=r + 1;
}
...
var jnx=CObjets[j].getX();var jny=CObjets[j].getY();animplaceObj(j,jnx,jny);
...
if(obj.contenu4!=''){
var parsedText=[];parsedText=obj.contenu4.split(";");
var lgt=parseInt(parsedText.length);if(lgt>3){
lgt=parseInt(lgt -1);
}
var portion=parseInt(max / lgt);var r=parseInt(x/portion);var nh=parsedText[r];if(typeof(nh) == 'undefined'){nh= "";}
if(nh!=""){
...
if(obj.contenu4!=''){
var parsedText=[];parsedText=obj.contenu4.split(";");
var lgt=parseInt(parsedText.length);for(var e=0 ; e < parsedText.length; e++){
var reponse=parsedText[e];var wh=4;if(reponse.indexOf(".jpg")!=-1
...
var line=document.createElement("div");var i=parseInt(id.replace('linenormals',''));if(document.getElementById(id)){
...
var x=sx - c / 2,
y=sy;
var alpha=Math.PI - Math.atan2(-b, a);createLineElement(id, x, y, c, alpha);
}
function drawLineCSS(id, x1, y1, x2, y2){
createLine(id, x1, y1, x2, y2);
}
function getColorLineLcm(i){
var col='#04B486';if(i==0||i==14||i==28){col='#04B45F';}
...
var line=document.createElement("div");if(document.getElementById(id)){
line=document.getElementById(id);
}else{
line.setAttribute('id', id);
document.getElementById('main').appendChild(line);
}
var styles='border: 2px solid #FA5858; '+ 'width: ' + length + 'px; '
+ 'height: 0px; '
+ '-moz-transform: rotate(' + angle + 'rad); '
+ '-webkit-transform: rotate(' + angle + 'rad); '
+ '-o-transform: rotate(' + angle + 'rad); '
...
var x=sx - c / 2,
y=sy;
var alpha=Math.PI - Math.atan2(-b, a);createLineElementRed(id, x, y, c, alpha);
}
function drawLineCSSRed(id, x1, y1, x2, y2){
createLineRed(id, x1, y1, x2, y2);
}
var LastStartX=0;var LastStartY=0;var dragdropTX=0;var dragdropTY=0;var TouchStartX=0;var TouchStartY=0;var TouchisMoving=false;var TouchSlide=false;var switchTabletNav=false;var ObjTouchDrag=-1;var TouchDistant=0;function AbsTouchStart(){
var Ecran=document.getElementById("main");TouchStartX=LastStartX - Ecran.offsetLeft;
TouchStartY=LastStartY - Ecran.offsetTop;
TouchStartX=parseInt(TouchStartX / zoom);
TouchStartY=parseInt(TouchStartY / zoom);
var Vobj=returnDragObject(TouchStartX,TouchStartY);ObjTouchDrag=Vobj.id;
}
function AbsTouchMove(){
if(ObjTouchDrag==-1){
var Ecran=document.getElementById("main");var TouchStartX2=dragdropTX - Ecran.offsetLeft;var TouchStartY2=dragdropTY - Ecran.offsetTop;TouchStartX2=parseInt(TouchStartX2 / zoom);
...
var Ecran=document.getElementById("main");if(onslidepage(TouchStartX,TouchStartY)){
if(TouchSlide==false){
var sobj=findSlidePage();if(sobj.id!=-1){
TouchSlide=true;
...
if(switchTabletNav){
if(ObjTouchDrag==-1){
var ecartx=10;if(dragdropTX<LastStartX-4){
if(TouchDistant<1){
...
if(ObjTouchDrag!=-1){
TouchDistant=TouchDistant + 1;
var ex=parseInt(dragdropTX - Ecran.offsetLeft) - parseInt(parseInt(CObjets[ObjTouchDrag].getW() * zoom)/2);var ey=parseInt(dragdropTY - Ecran.offsetTop) - parseInt(parseInt(CObjets[ObjTouchDrag].getH() * zoom)/2);if(CObjets[ObjTouchDrag].type=='dragslide'){
var x1=parseInt(ex / zoom);var x2=parseInt(CObjets[ObjTouchDrag].objx);if(x1<x2){
ex=(CObjets[ObjTouchDrag].objx) * zoom;
CObjets[ObjTouchDrag].setX(CObjets[ObjTouchDrag].objx);
}
var x3=parseInt(CObjets[ObjTouchDrag].text);if(x1 > (x2 + x3)){
...
var decx=parseInt(parseInt(CObjets[ObjTouchDrag].getW() * zoom)/2);var decy=parseInt(parseInt(CObjets[ObjTouchDrag].getH() * zoom)/2);var lx=parseInt(CObjets[ObjTouchDrag].objx * zoom) + decx;
...
var tempBloc=new CObjet();tempBloc.id=-1;
return tempBloc;
}
...
var Ecran=document.getElementById("main");Ecran.innerHTML=Ecran.innerHTML + '<div id="rapidlog" ><p>' + mess + '</p></div>';
}else{
document.getElementById("rapidlog").innerHTML='<p>' + mess + '</p>';
}
}
var drawingStarted={};var onPointerMoveS=function(eventObject){
...
if(isSurface()){
var plainCanvas=document.getElementById("main");/*plainCanvas.addEventListener("MSHoldVisual", function(e){ e.preventDefault(); }, false);
...
if(isSurface()){
PreventDefaultManipulationAndMouseEvent(eventObject);
var evtname=eventObject.type.toLowerCase();var pointerId=eventObject.pointerId;if(evtname== "mspointerdown"){
...
var errorsoundglobal=0;function playallsounds(){
if(globalSound==0&&globalMusic==0){
return false;
}
errorsoundglobal=0;
var useragt=navigator.userAgent.toUpperCase();var u1='';var u2='';var u3='';var mp3File='';var boucle=0;var no_exten='';if(useragt.indexOf("MSIE") != -1){
no_exten='.ogg';
}
for(var i=0; i < CObjets_count; i++){
...
var ifr=0;if(useragt.indexOf("TRIDENT/6.0")!=-1||useragt.indexOf("TRIDENT/7.0")!=-1){
if(u1.indexOf(".wav")!=-1){
AudioIE10Wav(u1);
ifr=1;
}else{
...
for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='scriptEvents'){
...
var mp3File='';if(globalSound==0&&globalMusic==0){
return false;
}
var useragt=navigator.userAgent.toUpperCase();if(typeof u1 === "undefined"){
u1='';
}
...
var h="<object type=\"audio/x-wav\" height=\"50\" width=\">50\">";if(u1!=''){
...
var fil=url.lastIndexOf('/');var fic=url.substring(fil + 1);
var h='<object type="application/x-shockwave-flash" data="images/player_mp3_mini.swf" width="2" height="2">';h += '<param name="movie" value="images/player_mp3_mini.swf" />';
...
var h="<audio preload='false' controls='controls' >";if(u1!=''){
h += "<source src='" + u1 + "' >";
}
if(u2!=''){
h += "<source src='" + u2 + "' >";
...
var sndid="mysoundh";stopAllSound();
if(document.getElementById(sndid)){
var audioElement;try{audioElement=document.getElementById(sndid);
...
try{var audioElement=document.createElement('audio');audioElement.setAttribute('src', u1);
...
try{playAudPGlobal=new Audio();
}catch(err){}
try{var audio=new Array();for(i=0; i < audio.length; i++){
...
try{var media=document.getElementsByTagName('audio');for(i=0; i < media.length; i++){
media[i].stop();
}
}catch(err){}
try{if(document.getElementById(idglobalsoundglobal)){
var audioG=document.getElementById(idglobalsoundglobal);if(!audioG.paused){
audioG.pause();
}
}
}catch(err){}
...
try{for(i=0; i < collAudiosObjects.length; i++){
...
var audio=document.createElement("audio");if(audio != null && audio.canPlayType && audio.canPlayType("audio/mp3")){
...
var collAudiosObjects=new Array();function lAudio(surl){
...
var lgt=langueextend.toLowerCase();lgt=lgt.replace('-','');
if(lgt==''){
lgt='en';
}
...
var audioObj=new Audio(surl);audioObj.name="sequencesound";
if(globalSound==0&&globalMusic==0){
audioObj.muted=true;
}
...
var playAudPGlobal;var playAudPGlobalPageId=-1;function playAudP(audObject){
if(globalSound==0){
audObject.muted=true;
}
playAudPGlobalPageId=LUDI.getNumPage();
var playPromise=audObject.play();if(playPromise !== undefined){
playPromise.then(function(){}).catch(function(error){
playAudPGlobal=audObject;
if(!document.getElementById("parametreOpacGesture")){
var h='<div id="parametreOpacGesture" onClick="playAudPGLOB();" ></div>';$("#main").append(h);
}
...
var objflux;function installflux(obj){
var Ecran=document.getElementById("main");var nbcol=parseInt(obj.data);var nbrows=parseInt(obj.note);if(obj.type=='flux'){
var wd='100%';if(nbrows==1){
wd='300%';
}
var h='<div style="border:solid 0px gray;overflow:hidden;" ';h=h + ' id="flux' + obj.id + '" class="bloc' + obj.id + '" ';
h=h + ' >';
...
var filtreselect='';if(document.getElementById("fluxsearch" + obj.id )){
var objlist=document.getElementById("fluxsearch" + obj.id);
if(!document.getElementById("selectflux" + obj.id)){
var lis=getListFlux(obj.id);objlist.innerHTML=lis;
}else{
if(document.getElementById("selectflux" + obj.id)){
...
var nbcol=parseInt(obj.data);var nbrows=parseInt(obj.note);var nbbypage=parseInt(nbcol * nbrows);var min_i=parseInt(obj.activepage * nbbypage);var max_i=parseInt(parseInt(min_i + nbbypage) - 1);
var h="";var j=0;var result=0;for(var i=0; i < CFlux_count; i++){
...
if(j>=min_i&&j<=max_i){
var rd=CFluxs[i].renderteaser(obj);rd=rd.replace("fluxbloc", "fluxbloc" + obj.id);
h=h + rd;
result=result +1;
}
j=j + 1;
...
var e_x=parseInt(obj.getX() * zoom);var e_y=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);$(".blocload" + obj.id).css("top", parseInt(e_y) + 'px').css("left", parseInt(e_x) + 'px');
$(".blocload" + obj.id).css("width", parseInt(wb) + 'px').css("height", parseInt(hb) + 'px');
var sfluxbloc= ".fluxbloc" + obj.id;
var nbcol=parseInt(obj.data);var new_w=parseInt(wb - (nbcol * 12));$(sfluxbloc).css("width", parseInt(new_w/ nbcol) + 'px');
var nbrows=parseInt(obj.note);var new_h=parseInt(hb - (nbrows * 12));$(sfluxbloc).css("height", parseInt(new_h/ nbrows) + 'px');
...
function loadFlux(){
var d=new Date();var n=d.getMinutes();$.ajax({
type: "GET",
url: 'flux/flux.xml',
dataType: (isMsie()) ? "text" : "xml",
cache:true,
...
var h="<div ";h=h + ' class="contentflux fluxbloc ' + obj.cssadd + '" ';
h=h + ' style="' + obj.css + '" ';
h=h + ' >';
...
h=h + '</div>';
var classbtn ="css3button";if(IE8==1||IE9==1){
classbtn ="ie8button";
}
...
var h="<div ";h=h + ' class="contentinner" ';
h=h + ' >';
h=h + '<div class="titreflux" >' + this.titre + '</div>';
...
var CFluxs=new Array();var CFlux_count=0;function CFluxs_Add(Elem){
Elem.id=CFlux_count;
CFluxs.push(Elem);
...
var tempBloc=new CFlux();tempBloc.titre=$(this).find('titre').text();
...
var mem='';for(var i=0; i < CFlux_count; i++){
if(CFluxs[i].tags!=''){
var rd=CFluxs[i].tags;if(rd.indexOf(',')!=-1){
var tableau=rd.split(',');for(var j=0; j<tableau.length; j++){
...
var Ecran=document.getElementById("main");if(obj.type=='geoline'){
var h='<img style="display:none;" ';h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h += ' src="data/' + obj.src + '" ';
h += ' />';
Ecran.innerHTML=Ecran.innerHTML + h;
}
}
var callcolorfond=0;var imagefondglobal="";var imagefondLoad="";function loadFullHdImg(p){
if(isImageC(imagefondglobal)){
imagefondLoad=imagefondglobal;
var imgBack=new Image();imgBack.id="backimg" + p ;
...
var Ecran=document.getElementById("main");callcolorfond=callcolorfond + 1;
var colFd=getColorfond();if(colFd.indexOf(".jpg")!=-1
||colFd.indexOf(".png")!=-1
||colFd.indexOf(".gif")!=-1
||colFd.indexOf(".svg")!=-1
...
var backfond=colFd.replace('repeat:','');h='<div style="display:none;opacity:1;position:absolute;z-index:0;';
...
var finalfond=getColorfond();if(getColorfond().indexOf("large:")!=-1){
finalfond=getColorfond().replace('large:','');
}
var ctrLoadFd=memimagepreload.indexOf(finalfond);var css3=recupCss3();if(css3){
var objMain=$('#main');var lowImage=finalfond.replace('images/','images/low-').replace('.png','.jpg');var dolceTrans='<div style="display:block;position:absolute;';dolceTrans += 'left:0px;top:0px;background-image:url(\'' + lowImage + '\');background-size:100% 100%;';
...
var lowImage=finalfond.replace('images/','images/low-').replace('.png','.jpg');if(finalfond.indexOf("fond-white.png")!=-1||ctrLoadFd!=-1){
lowImage=finalfond;
}
...
if(h!=""){
addToM(h);
var fdcol=$("#colorfond,#dolceTrans");fdcol.css("width", $("#main").width() + 'px');
...
try{Ecran.style.backgroundColor=getColorfond();
}catch(err){
...
var hc ='<div id="cadrefond" style="z-index:0;border:solid 1px black;position:absolute;" ></div>';Ecran.innerHTML=Ecran.innerHTML + hc;
var fdcadre=$("#cadrefond");fdcadre.css("background-Color",cadrecolorfond);
fdcadre.css("border-Color",cadrebordercolorfond);
}
if(headerfond=='1'||headerfond==1){
var hc ='<div id="cadreheader" style="z-index:0;border:solid 1px black;position:absolute;" ></div>';Ecran.innerHTML=Ecran.innerHTML + hc;
var fdcadre=$("#cadreheader");fdcadre.css("background-Color",headercolorfond);fdcadre.css("border-Color",headerbordercolorfond);
}
if(footerfond=='1'||footerfond==1){
var hc ='<div id="cadrefooter" style="z-index:0;border:solid 1px black;position:absolute;" ></div>';Ecran.innerHTML=Ecran.innerHTML + hc;
var fdcadre=$("#cadrefooter");fdcadre.css("background-Color",footercolorfond);fdcadre.css("border-Color",footerbordercolorfond);
}
dimensionneCadres();
}
}
if(document.getElementById("content")){
var cont=document.getElementById("content");var objMain= document.getElementById("main");cont.style.left= objMain.offsetLeft + 'px';
...
var finalfond=getColorfond().replace('large:','');var img1=finalfond.replace('/','/LARG1');if(document.getElementById("larg1")){
var ctr1=document.getElementById("larg1").src;if(ctr1.indexOf(img1)==-1){
$(".large").css("display","none");
}
}
if(!document.getElementById("larg1")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg1" class="larg1 large" ';
h += ' src="' + img1 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img2=finalfond.replace('/','/LARG2');if(!document.getElementById("larg2")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg2" class="larg2 large" ';
h += ' src="' + img2 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img3=finalfond.replace('/','/LARG3');if(!document.getElementById("larg3")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg3" class="larg3 large" ';
h += ' src="' + img3 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img4=finalfond.replace('/','/LARG4');if(!document.getElementById("larg4")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg4" class="larg4 large" ';
h += ' src="' + img4 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img5=finalfond.replace('/','/LARG5');if(!document.getElementById("larg5")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg5" class="larg5 large" ';
h += ' src="' + img5 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img6=finalfond.replace('/','/LARG6');if(!document.getElementById("larg6")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg6" class="larg6 large" ';
h += ' src="' + img6 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img7=finalfond.replace('/','/LARG7');if(!document.getElementById("larg7")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg7" class="larg7 large" ';
h += ' src="' + img7 + '" ';
h += ' />';
$("body").append(h);
}else{
...
var img8=finalfond.replace('/','/LARG8');if(!document.getElementById("larg8")){
var h='<img style="display:none;z-index:0;position:absolute;" ';h += ' id="larg8" class="larg8 large" ';
h += ' src="' + img8 + '" ';
h += ' />';
$("body").append(h);
}else{
...
if(document.getElementById("larg1")){
var objMain= document.getElementById("main");var lx= parseInt($("body").width() - (960 *zoom))/2;var ly= parseInt($("body").height() - (720 *zoom))/2;var larg1=document.getElementById("larg1");if(larg1){
...
var larg2=document.getElementById("larg2");if(larg2){
...
var larg3=document.getElementById("larg3");if(larg3){
...
var larg4=document.getElementById("larg4");if(larg4){
...
var requestMethod=el.requestFullScreen || el.webkitRequestFullScreen || el.mozRequestFullScreen || el.msRequestFullscreen;if(requestMethod){
...
var orix=0;var oriy=0;var N_T=0;var N_F=0;var menu_html='';var menu_global='data/page0.xml';var menu_load=0
var remarques='';var MessageFalse='';var colorfond="";var colorfondsvg="";var colorfond2="";var colorfondsvg2="";var largefondx="";var largefondy="";var cadrefond="";var cadrefondsvg="";var cadrecolorfond="";var cadrebordercolorfond="";var headerfond="";var headercolorfond="";var headerbordercolorfond="";var footerfond="";var footercolorfond="";var footerbordercolorfond="";var acceptMoveObj=1;var exceptionForkDragDrop=false;var scriptdiapo="";var scriptloop="";var lastPage1=0;var lastPage0=0;var nbpagesD=1;var tirageunique=0;var saveprogression=false;var saveprogressioncheckpoint=false;var saveprogressionident='';var scormProcessScore=0;var attemptProcess=0;var domainesliste='';var parametersapp='';function CObjet(){
var Ecran=document.getElementById("main");this.x;
this.y;
this.w;
this.h;
this.x2;
...
var decx=parseInt(orix);if(this.type=='menu'){decx=0;}
if(oriTypeSite=="classic-responsive"){
if(typesite=="mobile"){
if(this.x>480){
...
var e_y=parseInt(this.y * zoom);var wb=parseInt(this.w * zoom);var hb=parseInt(this.h * zoom);if(mobiSite){
...
var color="black";if(this.color){
color=this.color;
}
var align="center";if(this.align){
align=this.align;
}
var cssPlus="";if(this.css){
cssPlus=this.css;
}
if(this.create==0){
var h='';var act='';var actOnly='';this.realx=0;
if(this.url!=''){
...
var ur=this.url.replace('link:','');act=' onclick="javascript:window.open(\'' ;
act=act + ur + '\');return false;" ';
actOnly='javascript:window.open(\'' + ur + '\');';
}else{
var transDir='';if(this.x < 100){
transDir='left';
}
...
var ScreenAdd=document.getElementById("main");ScreenAdd.innerHTML=ScreenAdd.innerHTML + h;
appliqueDataB(this);
this.oldzoom=0;
this.create=1;
updatescore();
...
var selectcolor="red";if(this.selectcolor){
...
var wb=parseInt(this.w * zoom);var hb=parseInt(this.h * zoom);var larg=parseInt(parseInt(this.fontsize * 1.5) * zoom);if(jQuery().hideWords){
...
if(this.type=='textarea'){
var hb=parseInt(this.h * zoom);$("#viewport"+ this.id).css("height", hb + "px");
...
var obj=CObjets[i];$('.bloc' + obj.id).animateImages({
folder: "images",
loop  : obj.text,
data  : obj.src,
time  : obj.data
...
var tkanim=document.createElement('script');tkanim.src='javascript/jquery.anim.js';
tkanim.type='text/javascript';
var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(tkanim, s);
setTimeout('installAnimateImages(' + i+ ')',300);
}
}
var page_id="";var CObjets=new Array();var CObjets_count=0;function CObjets_Add(Elem){
...
var d=new Date();var n=d.getMinutes();if(localExec()){
var p=f.replace(".xml","");p=p.replace("data/","");
...
var datamemoire=new Array();var soundmemoire=new Array();function formatLangUrl(ur){
...
var nb=parseInt(gebi("DiapoNbDiapo").innerHTML);if(nb<3){
evolinit=evolinit + 240;
}
if(oldnav){
evolinit=evolinit + 110;
}else{
var timeecart=250;for(i=0; i<nb; i++){
...
var scormP=false;for(var i=0; i < CObjets_count; i++){
...
var xml_p;var retourson='';if(typeof data == "string"){
xml_p=StringtoXML(data);
}else{
xml_p=data;
}
$(xml_p).find('bloc').each(function(){
var Vtype=$(this).find('type').text();if(Vtype=='son'){
...
var memimagepreload="";function preloadAllFileFd(i){
if(i>1000){
return false;
}
var data=poff[i];if(typeof data === 'undefined'){
i++;data=poff[i];}
...
i++;data=poff[i];}
if(typeof data !== 'undefined'){
var nbHit=0;var xml_p;if(typeof data == "string"){
xml_p=StringtoXML(data);
}else{
xml_p=data;
}
var tempFond;$(xml_p).find('fond').each(function(){
...
$(xml_p).find('bloc').each(function(){
var tempType=$(this).find('type').text();var tempBoite=$(this).find('boite').text();if(tempType=='img'){
var tempSrc=$(this).find('src').text();if(isImageC(tempSrc)){
var imgLoadProcess=new Image();imgLoadProcess.onload=function(){};
imgLoadProcess.src=tempSrc;
nbHit++;
}
var tempAlter=$(this).find('contenu7').text();if(isImageC(tempAlter)){
var imgLoadProcessAlt=new Image();imgLoadProcessAlt.onload=function(){};
imgLoadProcessAlt.src=tempAlter;
nbHit++;
}
}
if(tempType=='circletarget'){
var tempdata=$(this).find('data').text();if(isImageC(tempdata)){
var imgLoadcircletarget=new Image();imgLoadcircletarget.onload=function(){};
imgLoadcircletarget.src='images/' + tempdata;
nbHit++;
}
}
if(tempType=='gamechangeimages'){
var tempDataSrc=$(this).find('src').text();if(isImageC(tempDataSrc)){
var imgLoadCir1=new Image();imgLoadCir1.onload=function(){};
...
var imgQcm0=new Image();imgQcm0.onload=function(){};
imgQcm0.src=tempSrcQcm0;
nbHit++;
var imgQcm1=new Image();imgQcm1.onload=function(){};
...
var domDataH='no';function addDom(){
if(domaddopt){
if(domDataH=='no'){
$.ajax({
type: "GET",
...
var transitionX=0;function loaddata(f,d){
allaysOnTop();
...
var onlyOneLF=true;if(transitionPage=='Explose'){
for(var i=0; i < CObjets_count; i++){
...
if(gebi("loaddiv")){
var loadDivObj=gebi("loaddiv");if(loadDivObj.tagName.toLowerCase()=='img'){
var newurlimg= gebi("loaddivtransiimage").innerHTML;$('#globalcurtainanim').css("background-image" , "url('" + newurlimg + "')");
}else{
...
if(gebi("loaddiv")){
var loadDivObj=document.getElementById("loaddiv");if(loadDivObj.tagName.toLowerCase()=='img'){
var newurlimg= gebi("loaddivtransiimage").innerHTML;$('#globalcurtainanim,#globalcurtainanim2').css("background-image" , "url('" + newurlimg + "')");
}else{
...
var MessageHelp='';function openDialogYNDown(title,file){
...
if(!gebi("dialogDown")){
var h='<div id="dialogDown" style="display:none;" >';h += inn;
h += '</div>';
addToM(h);
}else{
...
$("#dialogDown").fadeIn();
var wb=parseInt(350 * zoom);var hb=parseInt(60 * zoom);hb=gebi("dialogDown").offsetHeight;
...
if(!gebi("dialogDown")){
var h='<div id="dialogDown" style="display:none;" >';h=h + inn;
h=h + '</div>';
addToM(h);
}else{
gebi("dialogDown").innerHTML= inn ;
...
$(function(){
var control_hash=window.location.hash;if(current_hash==''){
var numDiapo='page0';if(document.getElementById("numpagemem")){
...
var p=current_hash.replace("#","");if(typeof(p) == 'undefined'){return false;}
if(numDiapo!='page0'){
...
var current_hash='';var active_hash='';function verifPage(){
if(!gebi("noNavigueparam")){
current_hash=window.location.hash;
if(active_hash!=current_hash&&active_hash!=''){
if(current_hash!=''){
active_hash=current_hash;
var p=active_hash.replace("#","");if(typeof(p) == 'undefined'){return false;}
menu_global='data/' + p + '.xml';
Url=menu_global;
if(p!=''){
loadFile( 'data/' + p + '.xml');
...
var HaveBilan=false;$(xml_p).find('bloc').each(function(){
var tempBloc=new CObjet();tempBloc.idscript=$(this).find('ids').text();
...
var tx=$(this).find('x').text();if(tx.indexOf('+')!=-1){
tempBloc.x=eval(tx);
}else{
tempBloc.x=parseInt(tx);
}
var ty=$(this).find('y').text();if(ty.indexOf('+')!=-1){
tempBloc.y=eval(ty);
}else{
...
tempBloc.text=cleTetS($(this).find('text').text());
}
if($(this).find('tx').length>0){
tempBloc.text=cleTetS($(this).find('tx').text());
}
tempBloc.initialtext=tempBloc.text;
if($(this).find('contenu2').length>0){
tempBloc.contenu2=cleTetS($(this).find('contenu2').text());
}
if($(this).find('tx2').length>0){
tempBloc.contenu2=cleTetS($(this).find('tx2').text());
}
...
var page=parseInt($(this).find('page').text());if(parseInt(externdatafilterpage)==page){
CObjets_Add(tempBloc);
}
}
nbcharge++;
...
var n=parseInt($(this).find('n').text());titlePage[n]=$(this).find('data').text();
});
...
var cps=$(this).find('d').text();if(typeof(cps) == 'undefined'){cps='';}
if(cps!=''){
...
$(xml_p).find('progsave').each(function(){
var cpscp=$(this).find('cp').text();if(typeof(cpscp) == 'undefined'){cpscp='';}
if(cpscp!=''){
...
var scrXDec=0;var scrYDec=0;if(obj.out==1){
...
var sid=".bloc" + obj.id;
var Tobj=$(sid);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var ctrx=parseInt(obj.realx);if(ctrx!=e_x){
if(acceptMoveObj==1){
...
var Timgbloc=$(simgbloc);Timgbloc.css("left",(e_x + scrXDec + 1 ) + "px");
}
}
if(obj.type=='infosbulle'){
...
zoomBoiteTexte(obj);
zoomIsoAvatar(obj);
var valfontsize=parseInt(obj.fontsize * zoom);Tobj.css("width", wb + "px");
...
if(obj.type=='img'){
var simgbloc=".imgbloc" + obj.id;
var Timgbloc=$(simgbloc);Timgbloc.css("width", (wb - 2) + "px").css("height",( hb - 2) + "px");
Timgbloc.css("left",(e_x + 1 ) + "px").css("top",(e_y + 1 ) + "px");
}
if(obj.type=='texthtml'){
var selectorspe=".bloc" + obj.id + ' .autosizebloc';
var FrameBloc=$(selectorspe);var nbFrame=FrameBloc.length;if(nbFrame>0){
...
var hpadd=parseInt(parseInt(hb - valfontsize)/2);$(".ipadbutton" + obj.id).css("padding-top",hpadd + "px").css("padding-bottom",hpadd + "px");
}
if(obj.type=='button'){
...
var wot1=parseFloat(hb * parseFloat(obj.contenu3));var wot=parseInt(wot1 * zoom);$("#imgbloc"  + obj.id).css("width", wot + 'px');
...
var bagW=parseInt(parseInt(obj.getW()* zoom) - 120)/2;var bagH=parseInt(parseInt(obj.getW() * zoom) - 120)/2;Tobjdrop.css("left", parseInt(parseInt(obj.getX()* zoom) + bagW) + 'px');
...
var dObj=true;if(obj.type=='geoline'){
if(obj.option7==1){
if(mobiSite==true){
dObj=true;
}else{
...
var tagName=document.getElementById(n).tagName;if(tagName=='SELECT'){
var get_id=document.getElementById(n);var resultselect=get_id.options[get_id.selectedIndex].value;return resultselect;
}
if(tagName=='INPUT'){
return document.getElementById(n).value;
}
if(tagName=='TEXTAREA'){
var ct=document.getElementById(n).value;ct=ct.replace('\n','<br />');
return ct;
}
}else{
return "-"
...
$("body").append(h);
var sid=".bloc" + obj.id;
var Tobj=$(sid);Tobj.addClass("outObjBody");
}else{
$("#main").append(h);
}
}
...
var ppos=(pos / largEcranWidth)*100;return ppos + "%";
}
function convertToPercentY(pos){
var ppos=(pos / largEcranHeight)*100;return ppos + "%";
}
...
var numAllP=LUDI.getFullNbPage();if(numAllP==0){
numAllP=1;
}
...
var historyExistDataPage=";";var historyNoExistDataPage=";";function pageNumExistXml(nb){
var b=false;var hc=true;if(historyExistDataPage.indexOf(";"+nb+";")!=-1){
b=true;
hc=false;
}
...
var data=poff[nb];if(typeof data === 'undefined'){
b=false
}else{
b=true;
}
...
var b=false;var xml_p;if(typeof dataExterneXml == "string"){
xml_p=StringtoXML(dataExterneXml);
}else{
xml_p=dataExterneXml;
}
$(xml_p).find('bloc').each(function(){
var page=parseInt($(this).find('page').text());if(nb==page){
b=true;
}
});
return b;
...
var temp=Source;var index=temp.indexOf(stf);while(index != -1){
...
var u=document.location.href;var reg=new RegExp('(\\?|&|^)'+param+'=(.*?)(&|$)');
matches=u.match(reg);
...
var u=document.location.href;var url=u, idx=url.indexOf("#")
var hash=idx != -1 ? url.substring(idx+1) : "";
return hash;
}
function getWindowHeight(){
var windowHeight=0;if(typeof(window.innerHeight) == 'number'){
...
var windowWidth=0;if(typeof(window.innerWidth) == 'number'){
...
var height=Math.max( body.scrollHeight, body.offsetHeight, html.clientHeight, html.scrollHeight, html.offsetHeight );return height ;
}
var omitformtags="input,textarea,select";function disableselect(e){
var tagn=e.target.tagName.toLowerCase();if(omitformtags.indexOf(tagn)==-1){return false;}
}
...
var globalDisplayTimer=3500;var globalDisplayTimerObj;var globalFirstMessage="";var modeTypeMessageIco=0;function alertm(mess){
displayMessage(mess);
}
function getbasedisplayMessage(){
var h="";if(parametersapp.indexOf('flatright')!=-1){
...
var firstLoadMessage=false;if(!gebi("centermessage")){
var h='<div id="centermessage" class="noslideobject" ><div id="centermessageinner" ><p>...</p></div></div>';$("#main").append(h);
...
var wb=parseInt(350 * zoom);var hb=parseInt(60 * zoom);hb=$("#centermessageinner p").height() + 45;
var om=$("#centermessage");om.css("height", hb + "px").css("width", wb + "px").css("z-index",'1000');
...
var stateHtml="";var stateColorfond1="";var stateColorfond2="";function recupMainStateHtml(){
...
var h='';for(var i=0; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.type=='material-panel'){
h += '<div ';
...
var backColor=$("#main").css("background-color");var widthDec=$("#main").width() + "px";
var heightDec=$("#main").height() + "px";
var h="<div id='ecranalter' class='ecranalter dataexptclass' ></div>";h += "<div id='ecranalter2' class='ecranalter2 dataexptclass' ></div>";
$("#main").append(h);
var ecranAlter=$("#ecranalter");ecranAlter.css("position","absolute");
...
var leftSld=false;if(lastPage0==(lastPage1-1)){
leftSld=true;
}
if(leftSld){
...
var leftSld=false;var widthDec= $("#main").width() + "px";
var widthDec2= ($("#main").width()*2) + "px";
if(lastPage0==(lastPage1-1)){
leftSld=true;
}
var stateHtml2= recupPanelsMat();$("#ecranalter2").append(stateHtml2);
if(colorfond.indexOf(".jpg")!=-1
||colorfond.indexOf(".png")!=-1
||colorfond.indexOf(".jpeg")!=-1){
...
if(stateColorfond2!=''){
var ecranAlter2=$('.ecranalter2');ecranAlter2.css("background-image", "url('" + stateColorfond2 + "')");
...
var CStocks=new Array();var CStocks_count=0;function stocksAdd(label,type,value,text){
Elem=new CStock();
Elem.label=label;
Elem.type=type;
Elem.value=value;
...
var i=0;for(i; i < CObjets_count; i++){
var Vobj=CObjets[i];if(Vobj.type=='text'){
...
var AutoSavePersistence=0;var ViewerAfterBilan=false;var ViewerAfterBilanList="";function CObjetMem(){
this.id;
this.idGlobal;
this.idScript;
this.x;
...
var i="<interaction>";i=i + "<id>" + this.id + "</id>";
...
var CObjetMems=new Array();var CObjetMems_count=0;function CObjetMems_Add(Elem){
...
var x='<?xml version="1.0" ?><interactions>';for(var i=0; i < CObjetMems_count; i++){
var obj=CObjetMems[i];x += obj.getInteractions();
}
...
var obj=CObjetMems[i];var objtype=obj.type;if(objectHaveAnote(objtype)||objtype=='dialog'){
if(obj.note_T!=0){
N_T=N_T + obj.note_T;
N_F=N_F + obj.note_F;
var rema=obj.remarque;if(typeof(rema) == 'undefined'){rema='';}
if(rema!=''){
...
var pourc=0;if(domainesN_F[obj.domaine]!=0&&domainesN_T[obj.domaine]!=0){
...
var bh=obj.bhtml;if(initExam==1){
...
var ratio=parseFlo(20/N_T);N_F=parseFlo(N_F - parseFlo(PenaltyExamBarre/ratio));
}
}
...
var detect=false;var objG;for(var i=0; i < CObjetMems_count; i++){
...
if(detect==false){
var tempObjectMem=new CObjetMem();tempObjectMem.numPage=numpage;
...
var repQCM='';var repQCM2='';var repQCM3='';if(obj.type=='qcmunique'){
...
$('#bloc' + obj.id + ' .reponseholetext').each(function(index){
var idctr=$(this).attr('id');var ctr2=gei(idctr);repQCM=repQCM + ctr2 + '|';
});
}
if(obj.type=='qcm'){
...
if(detect==false){
var tempObjectMem=new CObjetMem();tempObjectMem.idGlobal=idGlobal;
...
if(obj.type=='tcm'){
var eachElement=objG.value.split('|');var indexE=0;$('#bloc' + obj.id + ' .reponseholetext').each(function(index){
var idctr=$(this).attr('id');if(document.getElementById(idctr)){
...
var repQCM=objG.value;if(objG.value2==1){
$('.jepasse' + obj.id).html("X");
$('.jepassecocheimg' + obj.id).attr('src','fx/qcm/' + obj.boite + '1.png');
}else{
var eachElement=repQCM.split(';');var indexE=0;$('.carre' + obj.id + ', #' + obj.id + 'qcmunique' ).each(function(index){
var rep=parseInt(eachElement[indexE]);if(rep==1){
$(this).html("X");
...
var dl=document.getElementById(id);var el =0;var opt2=Sit(inVal);if(opt2!=''){
for(i=0; i<dl.options.length; i++){
var opt1=Sit(dl.options[i].value);if(opt1!=''){
if(opt1==opt2){
el=i;
}
}
...
var tempBloc=new CObjet();tempBloc.idscript='viewScreenApercu';
tempBloc.strscript='';
tempBloc.type='text';
...
tempBloc.AnimClic=0;
CObjets_Add(tempBloc);
var iNext=-1;if(ViewerAfterBilanList==''){
return false;
}
var eachElement=ViewerAfterBilanList.split(';');var i=0;var f=false;for(i=0; i < eachElement.length; i++){
if(eachElement[i]!=''){
if(f){
...
var nextButton=new CObjet();nextButton.idscript='';
...
var prevButton=new CObjet();prevButton.idscript='';
...
var numDiapo=document.getElementById("numpagemem").innerHTML;var hurl='data/' + numDiapo + '.xml';
menu_global=hurl;
loadFile(hurl);
},error: function(xhr, textStatus, errorThrown){
writeInConsole("Error " + xhr.status + " " + urlLinkInteractions);
...
CObjetMems_count=0;
var xml_p;if(typeof data == "string"){
xml_p=StringtoXML(data);
}else{
xml_p=data;
}
var HaveBilan=false;$(xml_p).find('interaction').each(function(){
var tempObjectMem=new CObjetMem();tempObjectMem.numPage=parseInteger($(this).find('numPage').text());
...
var lastPageMemId=parseInteger($(xml_p).find('lastPageMemId').text());actualExamIdScreen=$(xml_p).find('actualExamIdScreen').text();
...
if(initExam==1){
var j=0;$(xml_p).find('collDiapoExam').each(function(){
...
var ranbp=recalculAllNoteByPersistence();if(initExam==1){
var NbDiapo=parseInteger(document.getElementById("DiapoNbDiapo").innerHTML);if(lastPageMemId>NbDiapo||lastPageMemId==NbDiapo){
...
var unikProgressionAll=false;function getIDProgressionAll(){
if('function' == typeof(CheckLMSLearnerName)){
var vln=CheckLMSLearnerName();if(vln!=''){
learnerName=vln;
}
}
if(learnerName==''){
...
var idsession=getIDProgressionAll();var xmlprogress=getXmlInteractions();amplify.store(idsession,xmlprogress);
...
var idsession=getIDProgressionAll();var cont=amplify.store(idsession);unikProgressionAll=true;
if(cont==''){
return false;
}
...
var Ecran=document.getElementById("main");var title= 'Reprise : ' + dt  + '<br />Voulez-vous reprendre ?';
var inn='<p class="dialogDownTitle" >' + title + '</p>';
...
var h='<div id="dialogReprendre" style="display:none;" >';h=h + inn;
...
var wb=parseInt(350 * zoom);var hb=parseInt(100 * zoom);hb=document.getElementById("dialogReprendre").offsetHeight;
...
var idsession=getIDProgressionAll();var cont=amplify.store(idsession);if(cont==''){
...
var h=getBoite(obj);if(obj.boite==''&&obj.boite!='track'){
h=getBoite(obj);
}
var srctemp=obj.src;if(typeof(obj.contenu7) === "undefined"){
obj.contenu7='';
}
if(obj.contenu7!=''){
if(isSVGcompatible()){
...
var cssv=obj.cssadd;if(obj.strscript!=''){
...
var onmo='';if(obj.field1!=''){
var srcfield1=obj.field1;if(srcfield1.indexOf('/')==-1){
...
var mynoteStar=0;function installNotes(obj,act){
var Ecran=document.getElementById("main");var h="";var color="black";if(obj.color){color=obj.color;}
var cssPlus="";if(this.css){cssPlus=this.css;}
if(obj.type=='reset'){
N_T=0;
N_F=0;
remarques='';
...
if(obj.type=='badge'){
var im="fx/badges/BadgeNo.png";h='';
var resultSuccess=false;if(mynote>parseInt(parseInt(obj.text)-1)){
rediract=act;
...
var wb=parseInt(306 * zoom);var hb=parseInt(20 * zoom);$("#bloc-mask" + obj.id).css("left",xb + 'px').css("top",yb + 'px');
...
var nbqcmunique=0;var qcmRandomize=-1;var StockRepQ=new Array();function CRepQ(){
this.k;this.v;
}
...
var marginT='';if(obj.cssadd.indexOf("fixe")!=-1){
obj.theme ='tight';
...
var myString="";appliqueDataQCM(obj);
if(obj.text){
myString=obj.text;
}
var eachElement=myString.split(';');var MyNotes7="";if(obj.contenu7){
MyNotes7=obj.contenu7;
}
if(MyNotes7==""){"||||||||||||||||||"}
var eachElementNote=MyNotes7.split('|');var bilansource='<div class="blockbilan" >';bilansource=bilansource + '<div class="questbilan" >-prv-' + obj.contenu3 + '</div>';
bilansource=bilansource + '<ul>';
...
var nbrep=0;var totalrep=0;for(var e=0 ; e < eachElement.length; e++){
var reponse=eachElement[e];if(reponse.indexOf('*')==0){
nbrep=nbrep + 1;
}
if(reponse!=''){
totalrep=totalrep + 1;
...
if(totalrep>2){
if(qcmRandomize==1){
var ElemRepo=eachElement[0];var ElemNote=eachElementNote[0];eachElement[0]=eachElement[2];
eachElementNote[0]=eachElementNote[2];
eachElement[2]=ElemRepo;
eachElementNote[2]=ElemNote;
}
if(qcmRandomize==2){
var ElemRepo=eachElement[0];var ElemNote=eachElementNote[0];eachElement[0]=eachElement[1];
eachElementNote[0]=eachElementNote[1];
eachElement[1]=ElemRepo;
eachElementNote[1]=ElemNote;
}
if(qcmRandomize==3){
var ElemRepo=eachElement[totalrep-1];var ElemNote=eachElementNote[totalrep-1];eachElement[totalrep-1]=eachElement[0];
eachElementNote[totalrep-1]=eachElementNote[0];
eachElement[0]=ElemRepo;
eachElementNote[0]=ElemNote;
}
if(qcmRandomize==4){
var ElemRepo=eachElement[totalrep-1];var ElemNote=eachElementNote[totalrep-1];eachElement[totalrep-1]=eachElement[totalrep-2];
...
var preImg="";for(var e=0 ; e < eachElement.length; e++){
h += '<tr style="' + marginT + '" >';
var checkclass='qcmn';var reponse=eachElement[e];var rep=eachElement[e];if(reponse.indexOf('*')==0){
checkclass='qcmx';
...
var namerep=rep;var idRep=LUDI.guid();var rq=new CRepQ();rq.k=idRep;
rq.v=namerep;
StockRepQ.push(rq);
...
var randomname="qcm" + Math.floor(Math.random() * 10000) + "qcm" ;
var Ecran=document.getElementById("main");var color="black";if(obj.color){color=obj.color;}
...
var checkclass='qcmn';if(obj.data=='X'){
checkclass='qcmx';
...
var eachElementNote=MyNotes7.split('|');var bilansource='<div class="blockbilan" >';bilansource=bilansource + '<div class="questbilan" >-prv-' + obj.contenu3 + '</div>';
bilansource=bilansource + '<ul>';
var cols=obj.border.split('|');var h='<table cellpadding=0 cellspacing=1 ';h=h + 'style="display:none;';
h=h + 'color:' + color + ';';
...
var styleft="barStyQcmLeft";var styright="barStyQcmRight";var borcolor="border-color: " + cols[0] + ";";
if(e==0){
styleft="";
styright="";
borcolor="";
...
var cc=''
var styleft="barStyQcmLeft";var styright="barStyQcmRight";var barSty="barSty";if(barre==false){
styleft="";
styright="";
barSty="";
}
...
var checkclass='qcmn';var reponse='&nbsp;' + obj.contenu6;
var rep='';cc=cc + '<table class="qcmt cochecase cochecase' + obj.id + '" ' ;
...
if(obj.type=='qcm'&&obj.theme=='barre'){
var largqcm=parseInt(44 * zoom);var largQcmImg=parseInt((44-8) * zoom);var tid=".cochecase" + obj.id;
if(obj.boite==''){
...
if(obj.type=='qcm'&&(obj.theme==''||obj.theme=='tight')){
var largqcm=parseInt(parseInt(obj.contenu4) * zoom);if(largqcm<10){largqcm=10;}
...
if(obj.type=='qcmunique'){
var largqcm=parseInt(obj.getH() * zoom);var tid=".cochecase" + obj.id;
var num= $(tid).length;$(tid).css("font-size",parseInt((obj.fontsize * 0.8) * zoom) + "px");
var newlargCase=parseInt(largqcm-2) + "px";
$(tid).css("width",newlargCase);
$(tid).css("height",newlargCase);
var newlarg=largqcm + "px";
...
if(ViewerAfterBilan){return true;}
eventCatchScript=true;
var img=document.getElementById(imgid);if(nm!=''){
$('.' + nm).each(
function(index){
$(this).html("");
...
if(ViewerAfterBilan){return true;}
eventCatchScript=true;
var obj=document.getElementById(objid);if(nm!=''){
$('.' + nm).each(
function(index){
$(this).html("");
}
...
eventCatchScript=true;
for(var j=0; j < CObjets_count; j++){
var ctrObj=CObjets[j];if(ctrObj.type=='qcmunique'){
...
var h='<div style="left:50px;top:150px;width:450px;height:400px;" ';h += 'class="ludiSortableListSortable bloc' + obj.id + '"  >';
...
var h='';var eachElementTried=liste.split('|');for(var e=0 ; e < eachElementTried.length; e++){
var reponse=eachElementTried[e];if(reponse!=''){
h += '<li>' + reponse + '</li>';
}
}
return h;
...
var r="";var idul ='#advancedB-' + obj.id + " li";
...
var r="";var idul ='#advancedA-' + obj.id + " li";
$(idul).each(function(n){
r=r + $(this).html() + "|";
});
return r;
...
var eachElementTried1=L1.split('|');var eachElementTried2=L2.split('|');for(var e=0 ; e < eachElementTried1.length; e++){
var data1=Sit(eachElementTried1[e]);var data2=Sit(eachElementTried2[e]);if(data1!=''){
if(data2==''){
return false;
}
if(data2!=data1){
...
var mesreponses1=mesreponses.split('|');var eachElementTried2=L2.split('|');var r='<ul>';for(var e=0 ; e < mesreponses1.length; e++){
var data1=Sit(mesreponses1[e]);var data2=Sit(eachElementTried2[e]);if(data1!=''){
if(data2!=''){
if(data2==data1){
...
var Ecran=document.getElementById("main");var h='';if(obj.type=='textimg'){
var ht=getBoite(obj);var onmo='';var srctemp=obj.src;if(obj.field1!=''){
var srcfield1=obj.field1;if(srcfield1.indexOf('/')==-1){
srcfield1='images/' + obj.field1;
}
onmo=' onMouseOver="$(\'#bloc' + obj.id  + '\').attr(\'src\',\'' + srcfield1 + '\');" ';
...
h=h + ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + '" ';
h=h + ' src="' + srctemp + '" ';
h=h + act;
h=h + ' />';
h=h + '<table style="display:none;color:' + color + ';" ';
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + ' ' + obj.idscript + '" ';
h=h + ' >';
h=h + '<tr><td id="innerbloc' + obj.id + '" class="' + obj.idscript + 'inner" ';
h=h + ' style="text-align:center;color:' + color + ';' + obj.cssadd + '" ' + act  + onmo + ' ';
h=h + ' >';
h=h + obj.text;
h=h + '</td></tr></table>';
if(ht!=''){
...
var contentAffiche=appliqueVarsInTxt(obj.text);h += '<div style="padding:1%;" >' + contentAffiche + '</div>';
h += '</div>';
if(ht!=''){
h=h + ht;
}
...
if(obj.type=='text'){
var ht=getBoite(obj);if(obj.boite=="scrollpro"){
cssPlus="";
}
h='';
h += '<table style="display:none;color:' + color + ';" ';
...
h += ' >';
h += '<tr>';
h += '<td id="innerbloc' + obj.id + '" style="position:relative;' + alignByObj(obj) + cssPlus + obj.cssadd + '" class="unselectable ' +  obj.idscript + 'inner" unselectable="on" >';
var contentAffiche=appliqueVarsInTxt(obj.text);if(obj.boite=="scrollpro"){
...
var contentAffiche=appliqueVarsInTxt(obj.text);h=h + "<div id='tablescrool" + obj.id + "' style='width:100%;height:200px;overflow:auto;' >";
h=h +  contentAffiche;
h=h + "</div>"
h=h + '</td></tr></table>';
if(ht!=''){
...
var contentAffiche=appliqueVarsInTxt(obj.text);h=h + contentAffiche;
h=h + '<span></div>';
$('#main').append(h);
}
}
function zoomScrollText(i){
var obj=CObjets[i];var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);$("#tablescrool" + i).css("font-size",parseInt(obj.getFts() * zoom) + 'px');
...
var decM=(hb - hreal)/2;$("#tablescrool"+ i).css("top",decM + "px");
}
if(obj.align=='LeftBottom'||obj.align=='RightBottom'){
$("#tablescrool"+ i).css("position","absolute");
var decM=(hb - hreal);$("#tablescrool"+ i).css("top",decM + "px");
}
}
if(hreal==0){
...
var obj=CObjets[i];var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);var ftreal=parseInt($("#fit" + obj.id).attr("data-ftsize"));
var ftrealnew=ftreal;$("#fit" + obj.id).css("font-size",ftreal + 'px');
...
var difreal=parseInt(hb/3);if(hreal<difreal){
...
h += ' >';
var boit=obj.boite.replace("box","");h += '<div id="roundblue' + obj.id + '" class="' + boit + '" >';
var boitText=obj.boite.replace("box","text");h += '<div id="roundbluetext' + obj.id + '" class="' + boitText + '" >';
h += obj.text;
h += '</div></div></div>';
addToM(h);
}
...
var eachico=obj.contenu2.split('|');var eachtxt=obj.contenu3.split('|');var eachdiap=obj.contenu4.split('|');var h='<ul id="blockmenu' + obj.id + '" ';
...
if(obj.type=='boitetexte'){
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom) - 20;var hb=parseInt(obj.getH() * zoom) - 20;var tb=$(".table" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("width",wb + 'px');
tb.css("height",hb + 'px');
...
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var tb=$("#roundboutongray" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("z-index" ,obj.ind);
var marginR=parseInt(10);if(obj.getW()<80){
marginR=5;
}
...
if(obj.type=='panelboxshow'){
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom) + 5;
var hb=parseInt(obj.getH() * zoom);var tb=$("#LargegrayPanel" + obj.id);
tb.css("left",xb + 'px');
tb.css("top" ,yb + 'px');
tb.css("width",wb + 'px');
tb.css("height" ,hb + 'px');
...
if(obj.type=='panelslide'){
var yb=parseInt(obj.getY() * zoom);var hb=parseInt(obj.getH() * zoom);var tb=$("#LargePanelSide" + obj.id);
...
var largW=parseInt(obj.contenu5);if(largW>parseInt(largEcranWidth*zoom)){
...
if(obj.type=='panelcenter'){
var xb=parseInt(obj.getX() * zoom)-25;var yb=parseInt(obj.getY() * zoom)-25;var tb=$("#LPanelC" + obj.id);
tb.css("left" ,xb + 'px');
tb.css("top" ,yb + 'px');
...
var limity=parseInt(parseInt(largEcranHeight * zoom)-315);if(yb>limity){
yb=limity;
}
if(yb<5){
yb=5;
}
var limitx=parseInt(parseInt(largEcranWidth * zoom)-315);if(xb>limitx){
xb=limitx;
}
if(xb<5){
xb=5;
...
pcl.css("left",xb + 'px');
pcl.css("top" ,yb + 'px');
var fz=parseInt(obj.fontsize * zoom);if(fz<10){
fz=10;
}
...
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom) + parseInt(obj.getH() * zoom) + 10;
...
if(obj.type=='menuludiblock'){
var fz=parseInt(17 * zoom);$(".blockmenu a li").css("padding",fz + "px");
fz=parseInt(20 * zoom);
...
var activePanelSlideObject=-1;function actPbshow(i){
var obj=CObjets[i];if(typeof(obj)==='undefined'){
}else{
...
var yb=parseInt(obj.getY() * zoom);var hb=parseInt(375 * zoom);ctrOb.animate({
top: yb + "px",
height: hb + "px"
},500, function(){
});
...
obj.setY(obj.objy);
var yb=parseInt(obj.getY() * zoom);var hb=parseInt(obj.getH() * zoom);ctrOb.removeClass("LargegrayPanelOpen");
ctrOb.animate({
top: yb + "px",
height: hb + "px"
},500, function(){
...
var mr=ctrOb.css('marginLeft');var obj=CObjets[i];if(typeof(obj)==='undefined'){
}else{
if(obj.contenu5==""){
obj.contenu5=400;
}
var pw=parseInt(obj.contenu5);if(pw>parseInt(largEcranWidth*zoom)){
...
var ctrOb=$("#LargePanelSide" + i + ",#LargePanelSideInner" + i);
var mr=ctrOb.css('marginRight');var obj=CObjets[i];if(typeof(obj)==='undefined'){
}else{
if(obj.contenu5==""){
obj.contenu5=400;
}
...
var mynoteStar=0;function installshow(obj,posisty){
var Ecran=document.getElementById("main");var h='';h += '<img ';
h += ' id="bloc' + obj.id + '" class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h += ' src="' + obj.data + '" ';
...
var dec=765;var xb=parseInt((obj.getX() - (4 + dec)) * zoom);
var yb=parseInt((obj.getY() + 27 - dec) * zoom);
var wb=parseInt(155 * zoom) * 2;var hb=parseInt(155 * zoom) * 2;$("#starA" + obj.id).css("width",wb + 'px').css("height",hb + 'px');
$("#starA" + obj.id).css("left",xb + 'px').css("top",yb + 'px');
var xbB=parseInt((obj.getX() + 120) * zoom);
var ybB=parseInt((obj.getY() - (50 + dec)) * zoom);
var wbB=parseInt(160 * zoom) * 2;var hbB=parseInt(146 * zoom) * 2;$("#starB" + obj.id).css("width",wbB + 'px').css("height",hbB + 'px');
$("#starB" + obj.id).css("left",xbB + 'px').css("top",ybB + 'px');
var xbC=parseInt((obj.getX() + 303 + dec) * zoom);
var ybC=parseInt((obj.getY() + 27 - dec ) * zoom);
var wbC=parseInt(156 * zoom) * 2;var hbC=parseInt(156 * zoom) * 2;$("#starC" + obj.id).css("width", wbC + 'px').css("height", hbC + 'px');
$("#starC" + obj.id).css("left", xbC + 'px').css("top", ybC + 'px');
}
function zoomshowfinal(obj){
var xb=parseInt((obj.getX()- 4) * zoom);var yb=parseInt((obj.getY()+ 27) * zoom);
var wb=parseInt(155 * zoom);var hb=parseInt(155 * zoom);$("#starA" + obj.id).css("width",wb + 'px').css("height",hb + 'px');
$("#starA" + obj.id).css("left",xb + 'px').css("top",yb + 'px');
var xbB=parseInt((obj.getX() + 148) * zoom);
var ybB=parseInt((obj.getY() - 2) * zoom);var wbB=parseInt(160 * zoom);var hbB=parseInt(146 * zoom);$("#starB" + obj.id).css("width",wbB + 'px').css("height",hbB + 'px');
$("#starB" + obj.id).css("left",xbB + 'px').css("top",ybB + 'px');
var xbC=parseInt((obj.getX() + 303) * zoom);
var ybC=parseInt((obj.getY() + 27) * zoom);
var wbC=parseInt(156 * zoom);var hbC=parseInt(156 * zoom);$("#starC" + obj.id).css("width", wbC + 'px').css("height", hbC + 'px');
$("#starC" + obj.id).css("left", xbC + 'px').css("top", ybC + 'px');
}
function zoomshowA(i){
obj=CObjets[i];
var xb=parseInt((obj.getX() - 4) * zoom);var yb=parseInt((obj.getY() + 27) * zoom);
var wb=parseInt(155 * zoom);var hb=parseInt(155 * zoom);var objstar=$("#starA" + obj.id);
objstar.animate({
left: xb + "px",
top: yb + "px",
width: wb + "px",
...
var yb=parseInt((obj.getY() - 2) * zoom);var wb=parseInt(160 * zoom);var hb=parseInt(146 * zoom);var objstar=$("#starB" + obj.id);
objstar.animate({
left: xb + "px",
top: yb + "px",
width: wb + "px",
...
var wb=parseInt(156 * zoom);var hb=parseInt(156 * zoom);var objstar=$("#starC" + obj.id);
objstar.animate({
left: xb + "px",
top: yb + "px",
width: wb + "px",
...
var wbC=parseInt(85 * zoom);var hbC=parseInt(125 * zoom);$("#starD" + obj.id).css("width", wbC + 'px').css("height", hbC + 'px');
...
var idIsoHero='';function installIsoAvatar(obj){
if(obj.type=='gameisoavatar'){
var exIsoAvatar=obj.x;var eyIsoAvatar=obj.y;idIsoHero=exIsoAvatar + 'a' + Math.floor(Math.random()*10000);
var h='';h += '<div class="avatarKBody avatarKBody' + obj.id + '" >';
h += '<div style="background-image:url(\'images/' + obj.src + '\');" ';
...
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var ew=parseInt(obj.getW() * zoom);var eh=parseInt(obj.getH() * zoom);$('.avatarKBody' + obj.id ).css("z-index","2");
$('.avatarKBody' + obj.id ).css('left',ex + 'px').css('top',ey + 'px');
$('.avatarKBody' + obj.id ).css('width',ew + 'px').css('height',eh + 'px');
var zoomM=ew/110;$('.isoAvatarBodySprite' + obj.id ).css('transform','scale(' +  zoomM  + ')');
$('.isoAvatarBodySprite' + obj.id ).css('-ms-transform','scale(' +  zoomM + ')');
}
function eventClickIsoAvatar(){
if(haveIsoAvatar()){
var Ecran=document.getElementById("main");var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);if(noClickCancel(ex,ey)==false){
exIsoAvatarObj=ex;
eyIsoAvatarObj=ey;
...
var obj=getIsoAvatarObj();isMovingIsoAvatar=false;
$('.isoAvatarBodySprite' + obj.id ).removeClass("runBodySprite");
}
}
}
}
var exIsoAvatarObj=0;var eyIsoAvatarObj=0;var exIsoAvatar=0;var eyIsoAvatar=0;var isMovingIsoAvatar=false;function destiAvatarObjisOK(){
var ig=false;for(var i=0; i < CObjets_count; i++){
var CtrObj=CObjets[i];var ex=parseInt(CtrObj.getX());var ey=parseInt(CtrObj.getY());var ew=parseInt(CtrObj.getW());var eh=parseInt(CtrObj.getH());var CtrType=CtrObj.type;if(CtrType=='gamezoneaction'){
...
var angleHero=0;var angleDegrees=0;var obj=getIsoAvatarObj();if(obj){
var bottomX=obj.getX() + (obj.getW()/2);
var bottomY=obj.getY() + obj.getH();
$('.isoAvatarBodySprite' + obj.id ).addClass("runBodySprite");
try{angleHero=getAngle(bottomX,bottomY,exIsoAvatarObj,eyIsoAvatarObj);
...
var objx=evolx - (obj.getW()/2);var objy=evoly - (obj.getH());obj.setX(objx);
obj.setY(objy);
zoomIsoAvatar(obj);
var goleft=false;if(angleDegrees>-89&&angleDegrees<90){
goleft= true;
}
if(goleft){
if(angleDegrees<0){
...
var dist=distancepyta(evolx,evoly,exIsoAvatarObj,eyIsoAvatarObj);if(dist<7){
...
var br=false;for(var i=0; i < CObjets_count; i++){
...
var allDiapoQuest=new Array();var interactionNumber=0;var interactLogs="";var PopUpLimitControl=-1;var interactLost=0;function isok(){
if(ViewerAfterBilan){return true;}
var r=true;var minLog='';interactLost=0;
attemptProcess=attemptProcess + 1;
for(var i=0; i < CObjets_count; i++){
var Oty=CObjets[i].type;var Oid=CObjets[i].id;if(PopUpLimitControl==-1||PopUpLimitControl==CObjets[i].pp){
if(Oty=='qcm'){
...
var loopInt=false;$('#table' + Oid + ' .qcmn,#table' + Oid + ' .qcmx').each(function(index){
if($(this).html()=="X"){
loopInt=true;
}
});
...
var nbrep=0;for(var j=0; j < CObjets_count; j++){
var ctrObj=CObjets[j];if(ctrObj.type=='qcmunique'){
var tdunik='#' + ctrObj.id + 'qcmunique';
var nam=$(tdunik).attr('name');if(nam=='qcmx'){
if($(tdunik).html()!="X"){
r=false;
}else{
nbrep=nbrep +1;
...
var ctr1=$(this).attr('data-rep');var idctr=$(this).attr('id');var ctr2=gei(idctr);if(Sit(ctr2)==""){
interactLost++;
}
...
if(Oty=='drop'){
var objDrag=findObjByIdStr(CObjets[i].data);if(objDrag){
var ctrx=parseInt(objDrag.getX() + (objDrag.getW()/2));
var ctry=parseInt(objDrag.getY() + (objDrag.getH()/2));
var Cox=parseInt(CObjets[i].getX());if(ctrx<Cox){
r=false;
minLog='drop';
}
if(ctry<parseInt(CObjets[i].getY())){
...
if(Oty=='bag'){
var objBag=CObjets[i];var nbelementsbag=0;var nbelementsinbag=0;for(var j=0; j < CObjets_count; j++){
if(CObjets[j].type=='drag'){
var objDrag=CObjets[j];var ctrx=parseInt(objDrag.getX() + (objDrag.getW()/ 2));
var ctry=parseInt(objDrag.getY() + (objDrag.getH()/ 2));
if(isOnBag(objDrag)){
}else{
...
var nbelementsdrag=0;for(var j=0; j < CObjets_count; j++){
if(CObjets[j].type=='drag'){
...
if(Oty=='motatrier'){
var motareliercontrol=recupMotsaRelier(CObjets[i]);var ctrMotRelier=controlTwoListMotsaRelier(CObjets[i].data,motareliercontrol);if(ctrMotRelier==false){
r=false;
}
}
...
var r=false;var ctrx=parseInt(objDrag.getX() + (objDrag.getW() / 2));
var ctry=parseInt(objDrag.getY() + (objDrag.getH() / 2));
for(var j=0; j < CObjets_count; j++){
if(CObjets[j].type=='bag'){
var objBag=CObjets[j];if(objDrag.data==objBag.data){
if(ctrx>parseInt(objBag.getX())){
if(ctry>parseInt(objBag.getY())){
if(ctrx<parseInt(objBag.getX() + objBag.getW())){
if(ctry<parseInt(objBag.getY() + objBag.getH())){
...
var memNoteID="";function calculnote(){
if(ViewerAfterBilan){return true;}
partBilanResult="";
var tempTotalBilanXML='';var tempScore=0;var tempScoreMax=0;var tempAnnotations='';for(var i=0; i < CObjets_count; i++){
var r=true;var noteratio=1;var noteSpe=0;var tempBilanXML='';var srcBilan='';var CObjetAnswer='';var CObjetCorrectAnswer='';var Oty=CObjets[i].type;if(Oty=='ludidialog'){
...
var Xanswers='';$('#table' + CObjets[i].id + ' .qcmn').each(function(index){
if($(this).html()=="X"){
r=false;
var wrongA=$(this).attr('name');srcBilan=srcBilan.replace(wrongA,'<span style="color:red;text-decoration:line-through;" >' + wrongA + '</span>');
...
var reponseA=$(this).attr('name');CObjetCorrectAnswer=CObjetCorrectAnswer + Sst(cleanName(findTxtStockQ(reponseA))) + ',';
if($(this).html()!="X"){
r=false;
}else{
...
var Xanswers='';for(var j=0; j < CObjets_count; j++){
var ctrObj=CObjets[j];if(ctrObj.type=='qcmunique'){
chargeDataObjectMem(ctrObj,lastPage1);
var tdunik='#' + ctrObj.id + 'qcmunique';
var nam=$(tdunik).attr('name');var repQcmUnique=ctrObj.contenu3;if(repQcmUnique==''){
...
var controlVal=Sit(recuptar);tempBilanXML += '<answers><![CDATA[' + controlVal + ']]></answers>';
...
noteratio=1;
var pourcSpe=parseFlo(CObjets[i].contenu7);if(pourcSpe>0){
...
if(Oty=='drop'){
var objDrag=findObjByIdStr(CObjets[i].data);var ctrx=parseInt(objDrag.getX() + (objDrag.getW() / 2));
var ctry=parseInt(objDrag.getY() + (objDrag.getH() / 2));
...
if(Oty=='bag'){
var objBag=CObjets[i];var nbelementsbag=0;tempBilanXML += '<item id="' + CObjets[i].idscript + '" >';
tempBilanXML += '<type>' + Oty + '</type>';
tempBilanXML += '<resume>drag drop</resume>';
var listedrag='';var bilansource='<div class="blockbilan" >';bilansource += '<div class="questbilan" >-prv-Drag &amp; Drop</div>';
...
if(Oty=='holetext'||Oty=='tcm'){
chargeDataObjectMem(CObjets[i],lastPage1);
var titre="Texte &agrave; trous";if(CObjets[i].type=='tcm'){
titre="TCM";
}
...
var nbrep=0;var nbrepOk=0;$('#bloc' + CObjets[i].id + ' .reponseholetext').each(function(index){
nbrep=nbrep + 1;
var ctr1=$(this).attr('data-rep');var idctr=$(this).attr('id');var ctr2=gei(idctr);if(Sit(ctr1)!=Sit(ctr2)){
r=false;
var repo=ctr2;if(repo==''){repo='?';}
...
tempBilanXML += '<total>' + parseFlo(CObjets[i].note) + '</total>';
tempBilanXML += '</item>';
var bilansource='';bilansource=bilansource + '<div class="blockbilan" >';
...
var remarqueForObjet='';if(r==false){
...
try{domainesRemarques[CObjets[i].domaine]=domainesRemarques[CObjets[i].domaine] + CObjets[i].remarque + '<br />';
}catch(err){}
}
}
...
if(r){
var noteadd=parseFlo(CObjets[i].note);noteadd=noteadd * noteratio;
...
var result='false';if(r){result='true';}
var duration=0;try{duration=parseInt((new Date()).getTime() - screenTime);
}catch(e){}
...
var oty=obj.type.replace('plugques-','');var bilansource='';bilansource=bilansource + '<div class="blockbilan" >';
bilansource=bilansource + '<div class="questbilan" >';
if(r==false){
bilansource=bilansource + '<span style="color:red;" >&#9632;&nbsp;</span>';
}else{
...
var ctrfinal=false;var tableau=obj.text.split('|');for(var i=0;i<tableau.length;i++){
if(tableau[i]!=''){
var pf1=parseFloat(tableau[i].replace(",","."));var pf2=parseFloat(s);var rnd=parseInt(obj.border);if(obj.option==1&&rnd>0){
var rnd=parseInt(obj.border);var puiss=10;if(rnd==2){puiss=100;}
if(rnd==3){puiss=1000;}
...
var controlVal=parseFlo(num);var controlMin=parseFlo(obj.text);var controlMax=parseFlo(obj.contenu2);try{xmproce=new MathProcessor;
...
var scripts=obj.border.split('|');var ctrfinal =false;var controlVal=Sit($('#textareabloc' + obj.id).val());
if(controlVal!=''){
var tableau=obj.text.split('|');for(var i=0; i<tableau.length;i++){
if(tableau[i]!=''){
var ctrinterne=true;var mots=tableau[i].split(';');for(var j=0; j<mots.length;j++){
var controlMot=Sit(mots[j]);if(controlMot!=''){
...
var finalMessage='';var helpMessage=obj.data.split('@');for(var i=0; i<helpMessage.length;i++){
if(finalMessage==''){
if(helpMessage[i]!=''){
var messageContent=helpMessage[i].split('|');if(controlVal.indexOf(Sit(messageContent[0]))==-1){
...
var ctrfinal =false;var controlVal=Sit($('#input' + obj.id).val());
if(controlVal!=''){
var tableau=obj.text.split('|');for(var i=0; i<tableau.length;i++){
if(tableau[i]!=''){
var ctrinterne=true;var controlMot=Sit(tableau[i]);if(controlMot!=''){
if(controlVal.indexOf(controlMot)==-1){
ctrinterne=false;
}
}
...
var fakeBloc=new CObjet();fakeBloc.x=-10;
fakeBloc.y=-10;
fakeBloc.x2=-10;
fakeBloc.y2=-10;
fakeBloc.w=10;
...
if(obj.type=='button'){
var Ecran=document.getElementById("main");var color="black";var cssPlus="";if(obj.css){
cssPlus=obj.css;
}
if(obj.color){
color=obj.color;
}
var classbtn ="css3button";if(obj.boite!=''){
classbtn=obj.boite;
}
if(obj.text=="(invisible)"){
h='<a id="table' + obj.id + '" class="unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h=h + ' style="cursor:pointer;background-image:url(\'fx/transparent.png\');' + posisty + '" ';
h=h + act + '>';
h=h + '</a>';
}else{
if(oldnav){
...
var nbqcmunique=0;function installRptGraph(obj){
if(obj.type=='ludirpt2'){
var Ecran=document.getElementById("main");var libelles=obj.text.split('|');var rptcolors=obj.data.split(';');var h='<div style="position:absolute;" ';h += ' id="bloc' + obj.id + '" class="bloc' + obj.id + '" ';
h += '>';
...
var hb=parseInt(parseInt(obj.getH() -85) * zoom);var wb=parseInt(obj.getW() * zoom);$(".blocbarre" + obj.id).css("height" , hb + 'px');
$(".blocbarre" + obj.id).css("width" , wb + 'px');
$(".imgbarre" + obj.id).css("height" , parseInt(85 * zoom) + 'px');
$(".imgbarre" + obj.id).css("width" ,'100%');
}
var loadReponsesslide='<img class="loadslide" src="css/ajax_loader_orange.gif" />';var ecranhaveslidepage=0;function installslidepages(obj){
var h='';var act='';var Ecran=document.getElementById("main");if(obj.type=='slidepages'){
obj.evol=0;
...
h += ' />';
obj.idstr="";
var myString="";if(obj.text){myString=obj.text;}
var eachElement=myString.split(';');if(eachElement == null){
}else{
h += '<div id="page" class="SlideContainPage' + obj.id + '" ';
h += ' style="background-color:white;position:absolute;left:0px;top:0px;" ';
h += ' >' ;
obj.idstr="";
var timeelaps=300;for(var e=0 ; e < eachElement.length; e++){
var reponse=eachElement[e];if(reponse.indexOf(".xml")!=-1){
var pageid=idpagegen();obj.idstr=obj.idstr + ';' + pageid;
...
function idpagegen(){
var randomnumber=Math.floor(Math.random()*10000);var randomnumber2=Math.floor(Math.random()*10000);var pageId='page' + randomnumber + randomnumber2;
return pageId;
}
function zoomSlidePages(obj){
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);var ew=parseInt(obj.getW() * zoom);var eh=parseInt(obj.getH() * zoom);$(".parentPage" + obj.id).css("width",ew + 'px').css("height",eh + 'px');
...
this.zoomslide;
this.show_element=function(){
var Ecran=document.getElementById(this.nameecran);var e_x=parseInt(this.x * this.zoomslide);var e_y=parseInt(this.y * this.zoomslide);var wb=parseInt(this.w * this.zoomslide);var hb=parseInt(this.h * this.zoomslide);if(this.an==1){posisty="";}
var color="black";if(this.color){color=this.color;}
var align="center";if(this.align){align=this.align;}
var cssPlus="";if(this.css){cssPlus=this.css;}
if(this.create==0){
var h='';var act='';var actslide='';if(this.url!=''){
if(this.url.indexOf("link:")!=-1){
var ur=this.url.replace('link:','');act=' onclick="javascript:window.open(\'' + ur + '\');return false;" ';
}else{
var transDir='';if(this.x < 100){
transDir='left';
}
...
if(this.type=='img'){
var srctemp=this.src;if(srctemp.indexOf(".gif")!=-1){
srctemp=srctemp + '?g=' + Math.floor(Math.random()*10000)
}
h='<img ';
...
var contentAffiche=this.text;if(contentAffiche.indexOf('{Variable1}')!=-1){
...
var objM=trouveSlidePage(obj.nameecran);obj.zoomslide=objM.zoomslide;
var sid=".blocslide" + obj.id;
var wb=parseInt(obj.w * objM.zoomslide);var hb=parseInt(obj.h * objM.zoomslide);$(sid).css("position","absolute");
...
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='slidepages'){
var str=CObjets[i].idstr;if(str.indexOf(nameecran)!=-1){
return CObjets[i];
}
}
}
var tempBloc=new CObjet();tempBloc.zoomslide=zoom * 0.94;
return tempBloc;
}
var CObjetSlides=new Array();var CObjetSlides_count=0;function CObjetSlides_Add(Elem){
...
var d=new Date();var n=d.getMinutes();document.getElementById(nameecran).innerHTML=loadReponsesslide;
f=formatLangUrl(f);
if(localExec()){
var p=f.replace(".xml","");p=p.replace("data/","");
p=p.replace(langueextend,"");
...
$(xml_p).find('bloc').each(function(){
var tempBloc=new CObjetSlide();tempBloc.type=$(this).find('type').text();
tempBloc.src=$(this).find('src').text();
tempBloc.url=$(this).find('url').text();
...
$(xml_p).find('fond').each(function(){
var Slidcolorfond=$(this).find('data').text();if(Slidcolorfond.indexOf(".jpg")!=-1
...
var wf=CObjets[id].w * zoom;var evol=CObjets[id].evol;if(evol<CObjets[id].note){evol=evol + 1;}
...
var wf=CObjets[id].w * zoom;var evol=CObjets[id].evol;if(evol>0){evol=evol - 1;}
...
var h='<div id="divopacover" class="divopacover" ></div>';$("#main").append(h);
}
if(!document.getElementById("divwindowsligth")){
var h='<div id="divwindowsligth" class="divwindowsligth" ></div>';$("#main").append(h);
}
var objBarre=getPopBarre(num);var b='<div id="divwindowsobjBarre" style="position:absolute;left:0px;top:0px;right:0px;';b=b + 'background-color:'+objBarre.selectcolor+';color:'+objBarre.color+';" >';
b=b + '&nbsp;&nbsp;' + objBarre.text;
...
var xb=parseInt(((largEcranWidth-larg)/2) * zoom);var yb=parseInt(((largEcranHeight-haut)/2) * zoom);var wb=parseInt(larg * zoom);var hb=parseInt(haut * zoom);$('#divwindowsligth').css("left",xb + 'px').css("top",yb + 'px');
$('#divwindowsligth').css("width",wb + 'px').css("height",hb + 'px');
$('#divwindowsligth').addClass("slideludiscape");
var condi='if(lastPage0==' + lastPage0 + '){';
var condistop='}';setTimeout(condi + 'showWindowsLight(' + num + ')' + condistop, 1000);
}else{
closePopBarre();
}
}
...
for(var i=0; i < CObjets_count;i++){
var obj=CObjets[i];var sid=".bloc" + obj.id +",.alterbloc" + obj.id;
if(obj.pp!=0){
$(sid).css({opacity:0});
...
for(var i=0; i < CObjets_count;i++){
var obj=CObjets[i];if(obj.pp==num&&obj.type=='popBarre'){
return obj;
}
}
}
...
var transitionPage="Classic";var oldTransitionPage="Classic";var transitionDirection="";function objetanim(obj){
if(obj.type=="examBar"
||obj.type=="geoline"
...
var o_de=obj.de;var o_dedi=obj.dedi;if(CanalTempo==2){
o_de=obj.de2;
o_dedi=obj.dedi2;
}
if(obj.an==11&&o_de==0){
...
var condi='if(lastPage0==' + lastPage0 + '){';
var condistop='}';var sid=".bloc" + obj.id +",.alterbloc" + obj.id;
if(obj.pp!=0){
$(sid).css({ opacity: 0});
$(sid).css("margin-top", "-1000px");
return false;
...
if(obj.an!=1){
var xb=parseInt(obj.x * zoom);var yb=parseInt(obj.y * zoom);var wb=parseInt(obj.w * zoom);var hb=parseInt(obj.h * zoom);var ecranW= document.getElementById("main").offsetWidth;var ecranH= document.getElementById("main").offsetHeight;if(ecranW==0){ecranW=1000;}
...
var o_di=obj.di;if(CanalTempo==2){
o_di=obj.di2;
}
if(o_di==1){
if(!oldnav){
...
var actualTimeoutLudi=0;var CAnimEnvents=new Array();var CAnimEnvents_count=0;function CAnimEnvents_Add(Elem){
Elem.id=CAnimEnvents_count;
CAnimEnvents.push(Elem);
CAnimEnvents_count=CAnimEnvents_count +1;
}
function setTimeoutLudi(fct,time){
var tempBlocPage=new CAnimEnvent();tempBlocPage.time=actualTimeoutLudi + time;
...
var Skewx=CObjets[i].evol - 1;var Skewy=(CObjets[i].evol)*2;var sk=' skew(' + Skewx + 'deg,' + Skewy + 'deg)';
$(id).css({
WebkitTransform : sk ,
MozTransform   : sk,
MsTransform     : sk,
...
function anim12(){
var continu=false;for(var i=0; i < CObjets_count; i++){
if(CObjets[i].an==12){
continu=true;
}
}
...
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].an==12){
var o_de=CObjets[i].de;if(CanalTempo==2){
o_de=CObjets[i].de2;
}
var sid=".bloc" + CObjets[i].id + ",.alterbloc" + CObjets[i].id;
...
var sid="#table" + idobj;
var ind=0;var tempNd=250;$(sid + ' .phr').each(function(index){
if(ind==0){
var sd=$(this).css("display");if(sd=='none'){
ind=ind + 1;
...
var preloadIncrement=0;function activeObjectAnimClic(){
var j=-1;var ctrX=1500;var ctrY=1500;for(var i=0; i < CObjets_count; i++){
if(CObjets[i].an!=1){
...
var finalfond=colorfond;if(colorfond.indexOf("large:")!=-1){
...
var Base_MEM='';var BaseMEMdbl='';var BaseNodbl='';var Base_memoire=new Array();var BasePageTirageUnique=new Array();var QuestionAleaMemeEcran=false;function appliqueDataB(obj){
var eachContent;if(obj.linkcontenu!=''&&obj.linkcontenu.indexOf(':')!=-1){
...
if(obj.type=='text'){
if(obj.linkcontenu!=''){
var txt=recupDataLink(obj.linkcontenu,obj.text);$('#innerbloc' + obj.id).html(txt);
}
}
if(obj.type=='drag'){
if(obj.linkcontenu!=''){
...
if(obj.type=='img'){
if(obj.linkimage!=''){
var imgsrc=recupDataLink(obj.linkimage,obj.src);if(imgsrc==''){
...
if(obj.linkx!=''){
var nx=parseInt(recupDataLink(obj.linkx,obj.getX()));obj.setX(nx);
}
if(obj.linky!=''){
...
var oImg=document.getElementById("imgloadctr");oImg.src=isrc;
if(nb>0){
...
var eachContent;if(obj.linkcontenu!=''&&obj.linkcontenu.indexOf(':')!=-1){
eachContent=obj.linkcontenu.split(':');
var nameB=eachContent[0];VerifLoadBaseLink(nameB);
var ctrtext=recupDataLink(nameB + ':B','');
if(ctrtext!=''){
obj.remarque=ctrtext;
}
var text='';var nbr=0;ctrtext=recupDataLink(nameB + ':C','');
if(ctrtext!=''){
text=text + ctrtext;
nbr++;
}
...
var eachContent=linkcontenu.split(':');var nameB=eachContent[0];var col=eachContent[1];var nb=0;for(var i=0; i < CBase_count; i++){
if(CBases[i].NameBase==nameB){
nb=nb + 1;
}
}
var nbr=parseInt(Math.random() * nb);var memtest="!" + nameB + "-" + nbr;
if(tirageunique==1){
...
function loadB(f){
var baseOffCtr=false;if(typeof(basedataoff)!=='undefined'){
if(typeof(basedataoff[f])!=='undefined'){
baseOffCtr=true;
}
}
if(baseOffCtr){
var dataOff=basedataoff[f];openLinkBaseXML(dataOff,f);
}else{
...
var CBases=new Array();var CBase_count=0;function CBases_Add(Elem){
Elem.id=CBase_count;
CBases.push(Elem);
...
var tempBloc=new CBase();tempBloc.NameBase=nameB;
var nb=0;$(this).find('value').each(function(){
...
var filedata='';var PlanorigineX=-1;var PlanorigineY=-1 ;var PlanobjectifY=100 ;var objectifPlanorigineX=100;var objectifPlanorigineY=100 ;var objectifActive=0 ;var xcoordplan=0;var ycoordplan=0;var decxcoordplan=0;var decycoordplan=0;var backgroundcolorplan="white";var largXplan=0;function resetAllParametrePlan(){
filedata='';
PlanorigineX=-1;
PlanorigineY=-1 ;
PlanobjectifY=100 ;
...
var Ecran=document.getElementById("main");if(obj.type=='ludiplan'){
...
var CPlans=new Array();var CPlan_count=0;var planZoom=0.8;var planObjZoom=0.8;var initplanZoom=1;var initObjZoom=1;var movePlanZoom=0;function CPlans_Add(Elem){
Elem.id=CPlan_count;
Elem.create=0;
CPlans.push(Elem);
...
var wi=parseInt(document.getElementById("mymap").offsetWidth);if(wi>10){
if(PlanorigineY==-1){
PlanorigineX=wi /2;
var he=parseInt(document.getElementById("mymap").offsetHeight);PlanorigineY=parseInt(he/2) + parseInt(he * 0.15);
...
var e_y=PlanorigineY - parseInt(this.y * planZoom);if(this.create==0){
var h='';h=h + '<img id="blocplan' + this.id + '" ';
...
var mymap=document.getElementById("mymap");mymap.innerHTML=mymap.innerHTML + h;
this.create=1;
}else{
var planid="#blocplan" + this.id;
if(document.getElementById("blocplan" + this.id)){
if(this.TypeGeo==1||this.TypeGeo==2){
var wb=parseInt(this.w * planZoom);var hb=parseInt(this.h * planZoom);$(planid).css("left",(e_x - (wb / 2)) + "px").css("top",(e_y - ((hb / 4) *3)) + "px");
$(planid).fadeIn();
...
var wb=parseInt(this.w);var hb=parseInt(this.h);$(planid).css("left",(e_x - (wb / 2)) + "px").css("top",(e_y - hb) + "px");
$(planid).fadeIn();
$(planid).css("width", wb + "px").css("height",hb + "px");
...
var dx=document.getElementById("mymap").offsetWidth/2;var tx=dx + parseInt((objectifPlanorigineX * planZoom)*-1);
if(PlanorigineX>tx){
...
var dy=document.getElementById("mymap").offsetHeight/2;var ty=dy + parseInt((objectifPlanorigineY * planZoom));
if(PlanorigineY>ty){
...
var tempBloc=new CPlan();tempBloc.id=$(this).find('id').text();
...
var toolplan=0;function initludiplan(){
if(document.getElementById("mymap")){
initplanZoom=1;
initObjZoom=1;
objectifActive=0;
...
var mymap=document.getElementById("mymap");mymap.onmousedown=function(e){
calculCoordplan(e);
...
var mymap=document.getElementById("mymap");var haveTitleInPlan=false;for(var i=0; i < CPlan_count; i++){
if(CPlans[i].TypeGeo==10){
haveTitleInPlan=true;
}
}
var h="<table class='nomenclature' style='z-index:10;' >";h=h + '<tr onClick="placeToPlanReset();" >';
h=h + '<td class="lignenomenclaturereset" >&nbsp;Overview&nbsp;&nbsp;</td>';
h=h + '</tr>';
for(var i=0; i < CPlan_count; i++){
if(CPlans[i].TypeGeo==10){
var desc=CPlans[i].description;if(desc==''){
desc='&nbsp;';
}
...
var sid=".bloc" + obj.id;
var Tobj=$(sid);Tobj.css({ WebkitTransform : 'rotate(' + deg + 'deg)'});
...
var deg2radians=Math.PI * 2 / 360;var rad=deg * deg2radians ;var costheta=Math.cos(rad);var sintheta=Math.sin(rad);var M11=costheta;var M12=-sintheta;var M21=sintheta;var M22=costheta;var Dx;var Dy;var iecos;var iesin;var halfWidth;var halfHeight;var rad=deg*(Math.PI/180);iecos=Math.cos(rad);
iesin=Math.sin(rad);
...
var sid=".bloc" + obj.id;
var Tobj=$(sid);Tobj.css("-ms-filter",matr);
Tobj.css("filter",matr);
var ml=$(sid).width() - parseInt(obj.getW() * zoom);ml=ml / 2;
var hl=$(sid).height() - parseInt(obj.getH() * zoom);hl=hl / 2;
Tobj.css("margin-left",'-' + ml + 'px');
Tobj.css("margin-top",'-' + hl + 'px');
}
var SatisfationScore=0;function getSatisVal(Cobj){
var istr=Cobj.idscript.replace('satisfaction-','');var j=parseInt(istr);return j;
}
function installshareresult(obj){
if(obj.type=='shareresult'){
var Ecran=document.getElementById("main");var h='';var act=' onClick="launchshareresult(' + obj.id + ');" ';
var srctemp=obj.contenu2;var h='<img ';h += ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + '" ';
h += ' src="' + srctemp + '" ';
...
var par="";var libelles=obj.text.split('|');for(var i=0; i<parseInt(obj.src); i++){
if(libelles[i]!=''){
par=par + libelles[i] + '|';
var pourc=0;if(domainesN_F[i]!=0&&domainesN_T[i]!=0){
pourc=(domainesN_F[i] / domainesN_T[i]);
...
var fullBilanResult='';var partBilanResult='';var BilanXML='';var TitleBilanXML='';function installbilanresult(obj){
if(obj.type=='bilanresult'){
globalCompteurDecompt=false;
recalculAllNoteByPersistence();
var Ecran=document.getElementById("main");var h='';var act=' onClick="launchBilanResult(' + obj.id + ');" ';
var srctemp=obj.contenu2;var h='<img ';h += ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + '" ';
...
var h='';h=h + '<table style="display:none;margin:0;padding:0;" ';
h=h + ' id="table' + obj.id + '" class="bloc' + obj.id + '" >';
...
var i;for(i=0; i < StockRepQ.length; ++i){
var cv=StockRepQ[i].v;if(cn){cv=cleanName(cv)}
fbre=fbre.replace(StockRepQ[i].k,StockRepQ[i].v);
}
return fbre;
}
function findTxtStockQ(idk){
var i;var fbre="";for(i=0; i < StockRepQ.length; ++i){
...
function upBilan(i){
var wb=parseInt(CObjets[i].getW() * zoom);var hb=parseInt(CObjets[i].getH() * zoom);var wb_max=parseInt(wb * 1.1);var hb_max=parseInt(hb * 1.1);var dec_x=parseInt((wb_max - wb) / 2 );var dec_y=parseInt((hb_max - hb) / 2 );$('.bloc' + i).stop().animate({width :wb_max + 'px',height :hb_max + 'px',marginLeft :  '-' + dec_x + 'px',marginTop :  '-' + dec_y + 'px' } , 300);
}
function doBilan(i){
var wb=parseInt(CObjets[i].getW() * zoom);var hb=parseInt(CObjets[i].getH() * zoom);$('.bloc' + i).stop().animate({width : wb + 'px',height : hb + 'px',marginLeft : '0px',marginTop : '0px' } , 300);
}
function sendBilanLogs(title,mkript){
if(haveRightProcessPhp()){
var urlBase=parseTxt(window.top.location.origin);var msend=title + "--" + urlBase + "--" + interactLogs;
...
var pourcScore=parseInt(parseInt(mynote) * 5);var addXML='<score>' + pourcScore + '</score>';
...
var pourcScore=parseInt(parseInt(mynote) * 5);var addXML='Score : ' + pourcScore + '%<br>';
...
if(haveRightProcessPhp()){
var finalXML='<?xml version="1.0" ?>';finalXML=finalXML + '<result>';
finalXML=finalXML + getInfosSuppBilan() + BilanXML + '</result>';
var prepXML=netH(finalXML);var urlStat='process-stats';$.ajax({
type: "POST",
...
rH=rH + $('#' + elem).html();
var cla= 'class="blockbilan"';var sty='style="float:left;width:45%;padding:1%;margin:1%;font-size:15px;border:solid 1px gray;height:200px;" ';rH=ReplaceAll(rH,cla,sty);
cla= 'class=blockbilan';
rH=ReplaceAll(rH,cla,sty);
PopupElem(rH);
}
function PopupElem(data){
var uagent=navigator.userAgent.toUpperCase();var mywindow;if(uagent.indexOf("MSIE") != -1){
...
var FullEmail='';var urlDistanteConnexion='';function installconnexion(obj){
if(obj.type=='connexion'){
var h='';var act=' onClick="launchBilanResult(' + obj.id + ');" ';
var srctemp=obj.contenu2;var classtemp="";if(obj.boite=='flat'){classtemp=" mat-shadows-a";}
var h='<div ';h += ' id="bloc' + obj.id + '" class="unselectable bloc' + obj.id + classtemp + '" ';
h += ' style="';
...
h += '</td>';
h += '<td>';
var labelClass="labelconn";if(obj.boite=='flat'){labelClass="labelconnblack";}
if(obj.boite=='flat'){
...
var col1="pink";var col2="white";if(boite=='flat'){
var col1="#e64c65";var col2="black";}
var conn1=document.getElementById("conn1").value;var conn2=document.getElementById("conn2").value;if(conn1==''){
...
var ok=0;var xml_p;if(typeof data == "string"){
xml_p=StringtoXML(data);
}else{
xml_p=data;
}
$(xml_p).find('Member').each(function(){
var log=$(this).find('Login').text();var pass=$(this).find('Pass').text();if(conn1==log){
if(conn2==pass){
ok=1;
Variable1=conn1;
FullEmail=conn1;
...
var globalPlayAudio=0;var ludiHaveVideo=false;function installVideo(obj){
var Ecran=document.getElementById("main");var h='';if(obj.type=='videopreload'){
if(recupCss3()){
var req=new XMLHttpRequest();req.open('GET',obj.data,true);
req.responseType='blob';
req.onload=function(){
if(this.status===200){
var videoBlob=this.response;var vid=URL.createObjectURL(videoBlob);}
}
...
var widthvideo=parseInt(obj.getW() * zoom);var heightvideo=parseInt(obj.getH() * zoom);if(parseInt(obj.border)!=0){
var b= parseInt(parseInt(parseInt(parseInt(obj.border) * -1) * 2) * zoom);widthvideo =widthvideo  + b;
heightvideo=heightvideo + b;
}
var ident=LUDI.guid();if(obj.idscript!=''){
ident=obj.idscript;
}
...
h += ' playsinline ';
var sty='';if(obj.cssadd){
sty=obj.cssadd;
}
if(parseInt(obj.border)!=0){
var b= parseInt(obj.border ) * zoom;sty += "margin-left:" + b + "px;";
sty += "margin-top :" + b + "px;";
}
h += ' style="' + sty + '" ';
h += ' >';
var completePath='';try{if(navigator.userAgent.toUpperCase().indexOf("TRIDENT/5.0") != -1){
var path=window.location.pathname;path=path.replace("/C:/","C:/");
...
var datavideo=obj.data;datavideo=datavideo.replace('videow', widthvideo + 'px');
...
var h='';var leftvideo=parseInt(obj.getX() * zoom);var topvideo=parseInt(obj.getY() * zoom);var widthvideo=parseInt(obj.getW() * zoom);var heightvideo=parseInt(obj.getH() * zoom);if(parseInt(obj.border)!=0){
var b= parseInt(parseInt(parseInt(parseInt(obj.border) * -1) * 2) * zoom);widthvideo =widthvideo  + b;
heightvideo=heightvideo + b;
}
...
if(parseInt(obj.border)!=0){
var b= parseInt(obj.border ) * zoom;sty=sty + "margin-left:" + b + "px;";
...
$("#main").append(h);
try{$('.video-ludivideo'+ obj.id)[0].removeAttribute("controls");
}catch(err){}
setTimeout("loadAllLudiVideo(" + obj.id + ")",1000);
}
}
function noAudionoVideoSupport(){
var extraOldNavigator=false;if(navigator.userAgent.toUpperCase().indexOf("TRIDENT/4.0") != -1){//IE8
...
if(recupCss3()){
var audio=new Audio();audio.id=LUDI.guid();
audio.src=obj.data;
audio.preload="auto";
audio.volume=0.001;
...
var Ecran=document.getElementById("main");var h='';h=h + '<div style="display:none;position:absolute;border:solid 1px black;background-color:#333;" ';
h=h + ' id="audio' + obj.id + '" ';
...
var myString="";if(obj.text){myString=obj.text;}
var myTitle="";if(obj.contenu2){myTitle=obj.contenu2;}
var myImages="";if(obj.contenu3){myImages=obj.contenu3;}
var sty="style=\"position:relative;margin: 0px;padding: 9px 5px 10px;border-bottom: 1px solid #ccc;cursor: pointer;\"";var eachElement=myString.split(';');var eachTitle=myTitle.split(';');var eachImages=myImages.split(';');for(var e=0 ; e < eachElement.length; e++){
var reponse=eachElement[e];if(reponse!=''){
var reponseTitle=eachTitle[e];var reponseImage=eachImages[e];h=h + '<li ' + sty + ' onclick="loadFileAudioPlay(this,' + obj.id + ');" >';
h=h + '<a href="#" ';
...
var h='';h += '<div onclick="audiocCircleP(' + obj.id + ')" id="roundboutongray' + obj.id + '" ';
h += 'class="roundboutongray alterbloc' + obj.id + '" >';
h += '<a id="roundboutongrayinner' + obj.id + '" ';
if(obj.getW()<80){
...
var audioElementCircle;function audiocCircleP(id){
var objCircle=$("#roundboutongrayicon" + id);
var sndid="audioElementCircle";var back=objCircle.css('background-image');if(back.indexOf('playstop')==-1){
var obj=CObjets[id];if(document.getElementById(sndid)){
try{audioElementCircle=document.getElementById(sndid);
}catch(err){}
...
var source=document.createElement('source');source.src=obj.text;
...
try{audioElementCircle.pause();
audioElementCircle.currentTime=0;
}catch(err){}
try{audioElementCircle.loop=false;
}catch(err){}
if(audioElementCircle.autoplay){
audioElementCircle.autoplay=false;
}
...
var globalAudioMulti;function initAudiocreateMulti(){
try{var a=audiojs.createAll({
trackEnded: function(){
var next=$('ol li.playing').next();if(!next.length){
next=$('ol li').first();
next.addClass('playing').siblings().removeClass('playing');
audio.load($('a', next).attr('data-src'));
var imgDataId3=$('a', next).attr('data-id');var imgData3=$('a', next).attr('data-img');if(imgDataId3!=''){
...
var imgData=$('ol a').attr('data-img');var imgDataId=$('ol a').attr('data-id');if(imgData!=''){
...
var src=$('a', ob).attr('data-src');globalAudioMulti.load(src);
globalAudioMulti.play();
var imgDataId2=$('a', ob).attr('data-id');var imgData2=$('a', ob).attr('data-img');if(imgDataId2!=''){
$('.' + imgDataId2).attr("src",imgData2);
}
}
function initAudiocreateAll(){
try{audiojs.events.ready(function(){
...
try{audiojs.events.ready(function(){
var as=audiojs.createAll();if(typeof as[0] !== 'undefined'){
as[0].play();
}
});
}catch(e){}
...
if(obj.type=='audiomultihtml'){
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);$('.bloclist' + obj.id).css("left",xb + 'px').css("top",parseInt(yb + hb) + 'px').css("width",wb + 'px');
}
if(obj.type=='ludiplayerhtml'){
var widthvideo=parseInt(obj.getW() * zoom);var heightvideo=parseInt(obj.getH() * zoom);if(parseInt(obj.border)!=0){
var b= parseInt(parseInt(parseInt(parseInt(obj.border) * -1) * 2) * zoom);widthvideo =widthvideo  + b;
...
var xb=parseInt(obj.getX() * zoom);var yb=parseInt(obj.getY() * zoom);var wb=parseInt(obj.getW() * zoom);var hb=parseInt(obj.getH() * zoom);$('.bloc' + obj.id).css("left",xb + 'px').css("top",parseInt(yb) + 'px');
$('.bloc' + obj.id).css("width",wb + 'px').css("height",parseInt(hb) + 'px');
}
}
var textdomrapportw="";var nbdomrapportw=1;var textSendRapportW="";var SendRapportBool=0;var RapportWmkript="";function installReportWrite(obj){
if(obj.type=='reportw'){
globalCompteurDecompt=false;
recalculAllNoteByPersistence();
var color="black";if(obj.color){
...
var Ecran=document.getElementById("main");var h='';h += '<table style="color:' + color + ';" ';
h += ' id="table' + obj.id + '" unselectable="on" ';
h += ' class="haveflou unselectable bloc' + obj.id + ' ' +  obj.idscript + '" ';
h += ' >';
h += '<tr>';
...
var domP=new Array();for(var j=0;j<20;j++){
domP[j]=0;
}
for(var i=0; i<20; i++){
...
var titleh2=getInfosSuppBilanLearnerName();var hfull='';$(xml_p).find('rapport').each(function(){
var ctrscript=$(this).find('ctr').text();var textAdd=$(this).find('html').text();var typeO=parseInt($(this).find('type').text());var idCondition=parseInt($(this).find('condition').text());var idDom=parseInt($(this).find('valeur').text());var colorHtml=$(this).find('colorHtml').text();var textBold=$(this).find('bold').text();if(ctrscript.indexOf('if')==-1){
ctrscript='';
}
...
if(typeO==4){
var getbr=getBilanReportW();getbr=replaceIdStockQ(getbr,false);
...
var lg=parseInt(73 * parseInt(nbdomrapportw));var h='';h=h + '<div class="bargraph" style= "width:' + lg + 'px;">';
h=h + '<ul class="bars">';
var libelles=textdomrapportw.split('|');for(var i=0; i<parseInt(nbdomrapportw); i++){
if(libelles[i]!=''){
var id=i + 1;
var coef=domP[i] / 100;var he=parseInt(200 * coef);var lib=domP[i];if(domP[i]<5){
lib='';
}
...
var libelles=textdomrapportw.split('|');for(var i=0; i<parseInt(nbdomrapportw); i++){
if(libelles[i]!=''){
var lib=domP[i];h=h + '<li>' + libelles[i]  + ' ' + lib +  '%</li>';
}
}
h=h + '</ul></p>';
return h;
...
var h='<table style="width:98%;min-height:100px;" ><tr><td>';h=h + fullBilanResult + '</td></tr></table>';
return h;
}
function getPrintRapportW(){
var h='';h=h + '<div class="printBilanRapportW" onClick="PrintElemRapportW();" >';
h=h + '</div>';
return h;
}
function PrintElemRapportW(elem){
var rH=$('.reportw').html();$.ajax({
type: "GET",
url: 'css/ui.css',
cache:true,
async:false,
...
var extenLgProcess='.php';var MEMmynote;var MEMmkript;var MEMobjm;var MEMhistory;var MEMsrelai;function sendBilanMail(mynote,mkript,objm,history,srelai){
MEMmynote=mynote;
MEMmkript=mkript;
MEMobjm=objm;
MEMhistory=history;
MEMsrelai=srelai;
var titleh2=getInfosSuppBilanLearnerName();if(haveRightSendMail()){
...
var globalidentsend='';function sendRapportLudiMulti(t,msend,e){
...
var nsend=msend.substr(parseInt(e * 300),300);$.ajax({
type: 'GET',
...
var titleh2=getInfosSuppBilanLearnerName();if(haveRightProcessPhp()){
$.ajax({
type: "POST",
...
var ur=window.location.href;if(ur.indexOf("liberscol.fr")!=-1){
return false;
}
...
var ur=window.location.href;if(ur.indexOf("https:")!=-1){
return true;
}
return false;
}
function crossDomainGetLudi(urlp){
var iframeWindow;if(document.getElementById('ifrm')){
iframeWindow= $('#ifrm');
...
var iframe=document.createElement("iframe");var randomnumber=Math.floor(Math.random()*10000);var uniqueString="postcross" + randomnumber;
document.body.appendChild(iframe);
iframe.style.display="none";
iframe.contentWindow.name=uniqueString;
var form=document.createElement("form");form.target=uniqueString;
form.action=urlp;
form.method="POST";
...
var inputm=document.createElement("input");inputm.type="hidden";
inputm.name="m";
inputm.value=m;
...
var noaccent=['A','a','E','e','I','i','O','o','U','u','N','n','C','c'];for(var i=0; i < accent.length; i++){
...
var inn='<p class="dialogDownTitle" >Une erreur a été rencontré lors de l\'envoi.<br/>Merci de réessayer dans quelques secondes.</p>';inn +=  '<p><a href="#" class="buttonDialogDownNo"  onCLick="closeYNDown();" >Non</a>&nbsp;';
inn +=  '<a href="#" class="buttonDialogDownYes"  onCLick="';
if(typ==1){
...
var initExam=0;var collDiapoExam=new Array();var collDiapoExamIdPage=new Array();var collDiapoExamMemPages='';var memNoteIdExamBarre='';var limitDomaineExamBarre='';var diffeDomaineExamBarre='';var PenaltyExamBarre=0;var actualExamId=-1;var actualExamIdScreen=-1;var lastExamId=0;var lastAfterExamId=0;function installExamBarre(obj){
if(obj.type=='selectdomaine'){
var Ecran=document.getElementById("main");var h=obj.data;h=h.replace('{idsection}','bloc' + obj.id);
h=h.replace('{sectionclass}','bloc' + obj.id);
Ecran.innerHTML=Ecran.innerHTML + h;
}
if(obj.type=='examBar'){
var Ecran=document.getElementById("main");var h='<div ';h=h + 'style="position:absolute;';
...
h=h + '</div>';
Ecran.innerHTML=Ecran.innerHTML + h;
var nb=parseInt(document.getElementById("DiapoNbDiapo").innerHTML);var timeecart=250;for(i=0; i<nb; i++){
if(i!=lastPage0){
...
var Ecran=document.getElementById("main");var h='<div ';h += 'style="position:absolute;';
...
lastExamId=parseInt(obj.contenu3);
lastAfterExamId=parseInt(obj.contenu2);
var eachC=obj.data.split(';');var eachDomaine=obj.contenu4.split(';');var nb=parseInt(eachC.length);var listIdMem="";var nbQuestions=parseInt(parseInt(obj.border)+1);
var haveRecentTirage=true;var cont=amplify.store('storeexdata'+nbQuestions);
if(cont==''){
...
collDiapoExam[i]='1';
var nbr=parseInt(Math.random() * nb);var haveNoFind=true;for(var j=0;j<200;j++){
nbr=parseInt(Math.random()*(nb));
var domNum=parseInteger(eachDomaine[nbr]);var ctrFront=false;if(limitDomaineExamBarre==''||limitDomaineExamBarre.indexOf(domNum)!=-1){
ctrFront=true;
}
...
var allFalse=true;$('.domaineselect-list-cb').each(function (){
if(this.checked){
allFalse=false;
}
});
...
CObjetMems_count=0;
actualExamId=i;
var p=collDiapoExamIdPage[actualExamId];if(p!=''){
var ur="data/page" + p + ".xml";
loaddata(ur,'nonote');
...
var minJpg=collDiapoExamIdPage[i];if(minJpg!=''){
var src="data/page" + minJpg + ".jpg";
var posi=$('.exambarre').position();var largLink=(obj.offsetWidth + 4) * parseInt(i-1);
...
var fullBilanResult='';var BilanXML='';var TitleBilanXML='';function openSuivi(ur){
var Ecran=document.getElementById("main");if(!document.getElementById("suiviresult")){
var ipage=0;try
{
...
lastPage0=parseInt(ipage);
calculnote();
var h='';var mynote=0;var Hnote="";try
{
if(N_T!=0&&N_F!=0){
mynote=parseInt((N_F / N_T) * 20);
if(mynote<0){mynote=0;}
...
var onCorrection=false;var acceptCorrection=false;var greSpe='&#9632';var redSpe='red';function openCorrection(ur,strscript){
...
var Ecran=document.getElementById("main");var ipage=0;try
{
ipage=ur.replace("data/page","");
ipage=ipage.replace(".xml","");
}
...
lastPage0=parseInt(ipage);
calculnote();
var questionsActive=false;for(var i=0; i < CObjets_count; i++){
var Oty=CObjets[i].type;if(Oty=='qcm'){
...
var CorrectAnswer="";var timeCorrection=200;var idAnim=CObjets[i].id * 100;$('#table' + CObjets[i].id + ' .qcmn').each(function(index){
if($(this).html()=="X"){
r=false;
var wrongA=$(this).attr('name');var parent=$(this).parent().parent().parent().parent().parent().parent().find(".selectqcmline");var contenu=parent.html();parent.html("<span id='idAnim" + idAnim + "' >" + contenu + "</span>");
...
$('#table' + CObjets[i].id + ' .qcmx').each(function(index){
var reponseA=$(this).attr('name');CorrectAnswer=CorrectAnswer + reponseA + ',';
var parent=$(this).parent().parent().parent().parent().parent().parent().find(".selectqcmline");var contenu=parent.html();if($(this).html()!="X"){
r=false;
...
var nam=$(tdunik).attr('name');if(nam=='qcmx'){
var ctrval=$(tdunik).html();if(ctrval=="X"){
var ctrx=parseInt(CObjets[j].getX())-18;var ctry=parseInt(CObjets[j].getY())-5;var idAnim=i * 1000;var h="<div id='idAnim" + idAnim + "' ";
h=h + " style='position : absolute;left:" + convertToPercentX(ctrx) + ";top:" + convertToPercentY(ctry) + ";' ";
h=h + " class='goodMarkDiv' >&#10003;</div>"
$("#main").append(h);
var rx=parseInt(CObjets[j].getX())-6;var ry=parseInt(CObjets[j].getY())-6;var rw=parseInt(CObjets[j].getW())+9;
...
var VobjDrag=findObjByIdStr(CObjets[i].data);var ctrx=parseInt(VobjDrag.getX() + (VobjDrag.getW()/2));
var ctry=parseInt(VobjDrag.getY() + (VobjDrag.getH()/2));
var r=true;if(ctrx<parseInt(CObjets[i].getX())){
r=false;
}
if(ctry<parseInt(CObjets[i].getY())){
r=false;
...
var jnx=VobjDrag.getX();var jny=VobjDrag.getY();animplaceObj(VobjDrag.id,jnx,jny);
if(VobjDrag.idscript=='ludiscapelinks'){
var decx=parseInt(parseInt(VobjDrag.getW() * zoom)/2);var decy=parseInt(parseInt(VobjDrag.getH() * zoom)/2);var ox=parseInt(VobjDrag.getX() * zoom) + decx;
...
var collId=findObjCollByIdStr(CObjets[j].data);var arrayLength=collId.length;var progx =0;var progy =2;for(var b=0; b < arrayLength; b++){
var c=parseInt(collId[b]);var VobjDrag=CObjets[c]
var ctrx=parseInt(VobjDrag.getX() + (VobjDrag.getW() / 2));
var ctry=parseInt(VobjDrag.getY() + (VobjDrag.getH() / 2));
var r=true;if(ctrx<parseInt(CObjets[j].getX())){
r=false;
}
...
var ctrx=parseInt(VobjDrag.getX() + (VobjDrag.getW()/2));
var ctry=parseInt(VobjDrag.getY() + (VobjDrag.getH()/2));
var r=false;if(ctrx>parseInt(CObjets[j].getX())){
if(ctry>parseInt(CObjets[j].getY())){
if(ctrx<parseInt(CObjets[j].getX() + CObjets[j].getW())){
if(ctry<parseInt(CObjets[j].getY() + CObjets[j].getH())){
r=true;
...
var rep=$('.input' + CObjets[i].id ).attr('data-rep');
var displayrep=rep;var yrep=document.getElementById('input' + CObjets[i].id).value;
var ctrx=parseInt(parseInt(CObjets[i].getX() + (CObjets[i].getW()/2)) * zoom);
var ctry=parseInt(CObjets[i].getY() * zoom);var cl='tooltipsgreen';if(Sit(rep)!=Sit(yrep)||yrep==''){
cl='tooltipsred';
}else{
displayrep="&#x2714;";
}
...
var r=true;if(controlRepSyntaxe(CObjets[i],0)==false){
r=false;
}
var displayrep="";var ctrx=parseInt(parseInt(CObjets[i].getX() + (CObjets[i].getW()/2)) * zoom);
var ctry=parseInt(CObjets[i].getY() * zoom);var cl='tooltipsgreen';if(!r){
cl='tooltipsred';
displayrep="&#x2717;";
$('.textareabloc' + CObjets[i].id).css("color","red");
var ac=CObjets[i].contenu7;$('.textareabloc' + CObjets[i].id).val(ac);
}else{
displayrep="&#x2714;";
...
var motareliercontrol=recupMotsaRelier(CObjets[i]);var eachElementTried1=CObjets[i].data.split('|');var eachElementTried2=motareliercontrol.split('|');var idulA ='#advancedA-' + i;
var idulB ='#advancedB-' + i;
var ha="";var h="";var num=1;for(var e=0 ; e < eachElementTried1.length; e++){
var rep=eachElementTried1[e];var data1=Sit(eachElementTried1[e]);var data2=Sit(eachElementTried2[e]);if(data1!=''){
...
var collId= new Array();for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='drag'){
if(CObjets[i].data==data){
collId.push(i);
}
...
var obj=CObjets[i];var fct= obj.type.replace('plugques-','');fct=fct + 'ViewResults(obj)';
eval(fct);
}
...
if($(this).html()=="X"){
r=false;
var wrongA=$(this).attr('name');var parent=$(this).parent().parent().parent().parent().parent().parent().find(".selectqcmline");var contenu=parent.html();parent.html("<span id='idAnim" + idAnim + "' class='suiviErreurMark' >&#x2717;</span>" + contenu);
...
if($(tdunik).html()=="X"){
var ctrx=parseInt(CObjets[j].getX() * zoom)-18;var ctry=parseInt(CObjets[j].getY() * zoom)-5;var idAnim=i * 100;var h="<div id='idAnim" + idAnim + "' ";
...
/*
if(VobjDrag.idscript=='ludiscapelinks'){
var decx=parseInt(parseInt(VobjDrag.w * zoom)/2);var decy=parseInt(parseInt(VobjDrag.h * zoom)/2);var ox=parseInt(VobjDrag.x * zoom) + decx;
...
*/
var idAnim=CObjets[i].id * 100;var ta=$('#imgbloc' + VobjDrag.id);
ta.append("<div id='idAnim" + idAnim + "' class='suiviErreurMark errorMarkDiv' >&#x2717;</div>");
}
}
var memBagAuto
function processErreurBag(j){
var collId=findObjCollByIdStr(CObjets[j].data);var arrayLength=collId.length;for(var b=0; b < arrayLength; b++){
var c=parseInt(collId[b]);var VobjDrag=CObjets[c]
var ctrx=parseInt(VobjDrag.getX() + (VobjDrag.getW() / 2));
var ctry=parseInt(VobjDrag.getY() + (VobjDrag.getH() / 2));
var r=true;if(ctrx<parseInt(CObjets[j].getX())){
...
var rep=$('.input' + CObjets[i].id ).attr('data-rep');
var displayrep=rep;var yrep=document.getElementById('input' + CObjets[i].id).value;
var ctrx=parseInt(CObjets[i].getX() - 18 );var ctry=parseInt(CObjets[i].getY() * zoom)-5;if(Sit(rep)!=Sit(yrep)||yrep==''){
var idAnim=i * 100;var h="<div id='idAnim" + idAnim + "' ";
h=h + " style='left:" + ctrx + "px;top:" + ctry + "px;' ";
h=h + " class='suiviErreurMark errorMarkDiv' >&#x2717;</div>"
$("#main").append(h);
}
...
$('#bloc' + CObjets[i].id + ' .reponseholetext').each(function(index){
var ctr1=$(this).attr('data-rep');var idctr=$(this).attr('id');var ctr2=gei(idctr);if(Sit(ctr1)!=Sit(ctr2)){
var idAnim=CObjets[i].id * 100;var lst="<span id='idAnim" + idAnim + "' ";
...
$(idul).each(function(n){
var dataCtr=Sit($(this).html());if(data2==dataCtr){
...
var haveCanon=false;var paintBoules;function instalPhysics(obj){
var Ecran=document.getElementById("main");if(obj.type=='physicscanon'){
obj.onmove=0;
var tempBoule=new CBoule();h='<img ';
h += ' id="boule' + obj.id + '" ';
...
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='physicscanon'){
var Vobj= CObjets[i];/*degreeToWEBMatrix(Vobj,Vobj.rotation);
...
if(haveCanon){
if(CObjets[i].type=='physicscanon'){
var Vobj= CObjets[i];var Ecran=document.getElementById("main");var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);var angleCanon=getAngle(ex,ey,Vobj.getX() + (Vobj.getW()/2) ,Vobj.getY() + (Vobj.getH()/2));
...
var Vobj= CObjets[i];var Ecran=document.getElementById("main");var ex=parseInt(parseInt(xcoord - Ecran.offsetLeft) /zoom);var ey=parseInt(parseInt(ycoord - Ecran.offsetTop ) /zoom);var vojY=Vobj.getY();var angleTrack=getAngle(Vobj.getX() + (Vobj.getW()/2) ,vojY + (Vobj.getH()/2),ex,ey);
var decZoom=parseFlo(Vobj.contenu6);if(mobiSite){
decZoom=parseFlo(Vobj.contenu8);
}
var decX=parseInteger((8 * decZoom) * Math.cos(angleTrack));var decY=parseInteger((5 * decZoom) * Math.sin(angleTrack));var objId='.bloc' + Vobj.id;
var marGT=parseInteger($(objId).css('margin-top').replace('px',''));var marGL=parseInteger($(objId).css('margin-left').replace('px',''));if(marGL<50&&marGL>-50){
...
var deplace=10;var evolx=parseFloat(CBoules[i].x) +  ((deplace) * Math.cos(CBoules[i].angle *  (Math.PI/180 ) ));
...
var CBoules=new Array();var CBoule_count=0;function CBoules_Add(Elem){
Elem.id=CBoule_count;
CBoules.push(Elem);
CBoule_count=CBoule_count +1;
}
var LUDIlife=0;var LUDIlifegameover=0;var LUDIlifeheight=0;var LUDIlifeTotal=0;var LUDImoney=0;var LUDIscore=0;var LUDIspeed=15;var LUDIwait=0;var LUDIactualID="";var LUDIfuturID="";var LUDIrunScript=true;var LaScr=true;var LUDIrunPage=true;var LUDIactivePopUp=0;var LUDIrunPageIsOk=false;var LUDIactualPageIsOk=false;var runGameOver=false;var runOneLife=false;var LUDINbPageGlobal=-1;function ludiscape(){
...
var Vobj= CObjets[i];Vobj.setX(x);
Vobj.setY(y);
var ex=parseInt(Vobj.getX() * zoom);var ey=parseInt(Vobj.getY() * zoom);$(".bloc" + Vobj.id).css("left",ex + 'px').css("top",ey + 'px');
zoomBoite(Vobj);
zoomBoiteTexte(Vobj);
}
}
...
var Vobj;var Vobj2;var i=0;for(i; i < CObjets_count; i++){
...
var ex=parseInt(Vobj.getX() * zoom);var ey=parseInt(Vobj.getY() * zoom);var ew=parseInt(Vobj.getW() * zoom);var eh=parseInt(Vobj.getH() * zoom);$(".bloc" + Vobj.id).css("left",ex + 'px').css("top",ey + 'px');
...
if(globalSound==1){
var urlS=clAudio(s);playSoundOne(urlS,'');
}
};
...
LUDIrunPage=false;
setTimeout(function(){
var ip=menu_global.replace("data/page","");ip=ip.replace(".xml","");
...
var nbP=nbpagesD;if(typeof dataExterneXml!=='undefined'){
nbP=0;
for(var i=0;i<800;i++){
...
var objBarre=getPopBarre(num);var larg=objBarre.w;var haut=objBarre.contenu2;openWindowsLight(num,larg,haut);
};
...
var nb=parseInt(document.getElementById("DiapoNbDiapo").innerHTML);var dec=0;for(i=0; i<nb; i++){
var ctrStr=parseInt(allDiapoQuest[i]);if(ctrStr==1){
if(initExam==0){
if(memNoteID.indexOf('p' + i + ';' )==-1){
N_T=N_T + 1;
dec=dec + 1;
...
if(dec>0){
var p='Pénalité';if(langue!='fr'){p='Penalty';}
var rem='<span style="color:red;" >Penalty -' + dec + '</span>';
remarques=remarques + rem + '<br />';
var tempBloc=new CObjet();tempBloc.id=999;
tempBloc.type='qcm';
...
if(runOneLife==false){
runOneLife=true;
var LIFEanim=LUDIlife - 1;if(LIFEanim<0||LIFEanim==LUDIlifeTotal){
LIFEanim=0;
}
LUDIlife=LUDIlife - 1;
if(LUDIlife==0||LUDIlife<1){
...
var LIFEanim=LUDIlife;if(LIFEanim<0||LIFEanim==LUDIlifeTotal){
LIFEanim=0;
}
var objLife=$(".gamelife" + LIFEanim);
LUDIlife=LUDIlife + 1;
...
var bret=false;$("." + s + ' .cochecase tr td').each(function(index){
if($(this).html()=="X"){
...
var txt="";$("." + s + ' .qcmn').each(function(index){
if($(this).html()=="X"){
var recolteW=$(this).attr('name');recolteW=findTxtStockQ(recolteW);
...
var i=0;for(i; i < CObjets_count; i++){
var obj=CObjets[i];if(obj.idscript==s){
...
var videoObj;if(document.getElementById('video' + s)){
...
var source=document.createElement('source');source.src=url;
source.type='video/mp4';
source.id='srcvid' + s;
...
var i=0;for(i; i < CObjets_count; i++){
var Vobj= CObjets[i];if(Vobj.type=='maptarget'){
reculeMapTargetID(i);
...
var bilansource='<div class="blockbilan" >';bilansource=bilansource + '<div class="questbilan" >-prv-' + name + '</div>';
bilansource=bilansource + '<ul>';
...
if(detect==false){
var tempObjectMem=new CObjetMem();tempObjectMem.numPage=ip;
tempObjectMem.idGlobal=idGlobal;
...
var t=this.createBase('img');t.x=x;t.y=y;t.w=w;t.h=h;
t.src='fx/close.png';
if(url!=''){t.src=url;}
CObjets_Add(t);
};
...
var LUDI=new ludiscape();function LUDIrotateAll(id,rot){
var i=0;for(i; i < CObjets_count; i++){
if(CObjets[i].idscript==id){
var Vobj= CObjets[i];Vobj.rotation=rot;
if(rotateIE()){
...
function rotateIE(){
var oldnav=false;if(navigator.userAgent.toUpperCase().indexOf("TRIDENT/5.0") != -1){
oldnav=true;
}
if(navigator.userAgent.toUpperCase().indexOf("TRIDENT/4.0") != -1){
oldnav=true;
...
var nh=Vobj.initialtext.replace('{score}',LUDIscore);$("#innerbloc" + Vobj.id).html(nh);
}
if(Vobj.initialtext.indexOf('{time}')!=-1){
var tim=MillisecondsToTime((new Date()).getTime() - ScormStartTime);var nh=Vobj.initialtext.replace('{time}', tim);$("#innerbloc" + Vobj.id).html(nh);
}
}
...
var i=0;for(i; i < CObjets_count; i++){
if(CObjets[i].idscript==id){
var Vobj= CObjets[i];LUDItranslate(Vobj,x,y);
}
}
}
...
var angleLUDI=0;try{angleLUDI=getAngle(obj.getX(),obj.getY(),obj.objx,obj.objy);
}catch(err){}
var dist=distancepyta(obj.objx,obj.objy,obj.getX(),obj.getY());var deplace=parseInt(LUDIspeed * zoom);if(dist>LUDIspeed){
var evolx=parseFloat(obj.getX()) + ((deplace) * Math.cos(angleLUDI));
var evoly=parseFloat(obj.getY()) + ((deplace) * Math.sin(angleLUDI));
obj.setX(evolx);
obj.setY(evoly);
var ex=parseInt(obj.getX() * zoom);var ey=parseInt(obj.getY() * zoom);$(".bloc" + obj.id).css("left",ex + 'px').css("top",ey + 'px');
zoomBoite(obj);
if(LUDIrunScript){
...
var lexiquePosX=0;var lexiquePosY=0;var lexiqueLoadAll=0;var lexiqueObject;function ShowLexique(id){
if(lexiqueLoadAll==0){
lexiqueLoadAll=1;
loadLexiques();
}
lexiqueObject=getElementLexique(id);
var Ecran=document.getElementById("main");var hm='<div class="lexiqueContent" style="overflow:hidden;" >';hm += '<p class="lexiqueTitle" >' + lexiqueObject.term + '</p>';
...
var h='<div id="lexiqueBox" class="lexiqueBox" >';h += hm;
h += '</div>';
$("#main").append(h);
}else{
$("#lexiqueBox").empty();
...
var $this=$(this);var lx= parseInt($("body").width()  - (largEcranWidth *zoom))/2;var ly= parseInt($("body").height() - (largEcranHeight *zoom))/2;lexiquePosX=parseInt(parseInt(xcoord - lx) - 80);
...
var hm='<div class="lexiqueContentLarg" style="overflow:auto;" >';hm += '<p>' + lexiqueObject.detail + '</p>';
hm += '</div>';
hm += '<a class="delLexique" onClick="$(\'#lexiqueBox\').fadeOut()" ></a>';
if(lexiquePosY<parseInt((largEcranHeight *zoom)/2)){
...
if(localExec()){
var data=doff['lexique'];openLexiqueXML(data);
}else{
var d=new Date();var n=d.getMinutes();$.ajax({
type: "GET",
...
var CLexiques=new Array();var CLexique_count=0;function CLexiques_Add(Elem){
...
var tempBloc=new CLexique();tempBloc.idRef=$(this).find('ID').text();
...
var globalSound=1;var globalMusic=1;function launchPara(){
if(!document.getElementById("parametrebox")){
var h='<div id="parametreOpac" onClick="closePara()" ></div>';h += '<div id="parametrebox" >';
...
var h='<h1>PARAMETRES</h1>';h += '<table style="" ><tbody>';
h += '<tr>';
...
$('#langbox').fadeOut();
var ext=lg;if(langueextend!=ext){
if(haveLocalFileUrl()){
if(ext==""){
...
var callXapiScore=0;function SetXapiScore(success,score_raw){
if(callXapiScore==0){
callXapiScore=1;
if('function' == typeof(openelearningFinishActivity)){
var duration=MillisecondsToTimeXapi((new Date()).getTime() - ScormStartTime);var activityId="";var title="";try{if(document.getElementById("xapiActivityID")){
activityId=document.getElementById("xapiActivityID").innerHTML;
}
}catch(e){}
try{if(document.getElementById("xapiTitle")){
title=document.getElementById("xapiTitle").innerHTML;
}
}catch(e){}
var login='';openelearningFinishActivity(login,activityId,title,success,duration,score_raw);
}
}
}
var callXapiEnd=0;function SetXapiEnd(score_raw){
if(callXapiEnd==0){
callXapiEnd=1;
var duration=0;try{duration=parseInt((new Date()).getTime() - ScormStartTime);
}catch(e){}
var activityId="";var title="";try{if(document.getElementById("xapiActivityID")){
activityId=document.getElementById("xapiActivityID").innerHTML;
}
}catch(e){}
try{if(document.getElementById("xapiTitle")){
...
var login=getLoginNameUnik();if('function' == typeof(openelearningFinishAll)){
openelearningFinishAll(login,activityId,title,duration,score_raw);
}
if(document.getElementById("linkParams")){
var obnote=document.getElementById("linkParams");var linkP='?h=1&r=finish&l=' + login + '&a=' + activityId + '&d=' + duration + '&s=' + score_raw ;
...
var login=getLoginNameUnik();var pageId=parseInt(lastPage1);if('function' == typeof(openelearningFinishScreen)){
openelearningFinishScreen(login,activityId,pageId,title,duration,tempScore,tempScoreMax,tempAnnotations,tempBilanXML);
}
if(document.getElementById("linkParams")){
var obnote=document.getElementById("linkParams");var linkP='?h=0&r=screen&l=' + login + '&a=' + activityId + '&p=' + pageId + '&d=' + duration + '&s=' + tempScore + '&t=' + tempScoreMax;
obnote.innerHTML=linkP;
}
}
function SetXapiInteraction(n,obj,duration,result,answer,correctAnswer){
var a=parseTxt(answer);if(a!=''){
interactLogs += parseTxt(obj.idscript) + "-(" + a + ")";
}
if('function' == typeof(ScormInteractionCom)){
var idscript=parseTxt(obj.idscript);var description=parseTxt(obj.idscript);if(obj.type=='qcm'){
if(obj.contenu3!=''){
...
var rt='';if('function' == typeof(CheckLMSLearnerName)){
var vln=CheckLMSLearnerName();if(vln!=''){
rt=vln;
}
}
